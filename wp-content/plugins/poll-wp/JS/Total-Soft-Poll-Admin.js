  ...
  var PollIntervId = setInterval(function () {
    ...
    if (code.indexOf('https://www.youtube.com/') > 0) {
      ...
      if (code.indexOf('embed') > 0) {
        ...
        jQuery('#TotalSoftPoll_Video_2').val(url);
        jQuery('#TotalSoftPoll_Video_1').val(url);
        if (jQuery('#TotalSoftPoll_Video_1').val().length > 0) {
          clearInterval(PollIntervId);
          jQuery('#TotalSoftPoll_Video_1').val('');
        }
      } else if (code.indexOf('video') > 0) {
        var TotalSoftCodes1 = code.split('mp4="');
        var TotalSoftCodeSrc = TotalSoftCodes1[1].split('"]');
        jQuery('#TotalSoftPoll_Video_2').val(TotalSoftCodeSrc[0]);
        jQuery('#TotalSoftPoll_Video_1').val(TotalSoftCodeSrc[0]);
        if (jQuery('#TotalSoftPoll_Video_1').val().length > 0) {
          clearInterval(PollIntervId);
          jQuery('#TotalSoftPoll_Video_1').val('');
        }
...
function TS_Poll_Theme_Preview_T() {
  ...
  if (TotalSoft_Poll_TType == 'Standart Poll' || TotalSoft_Poll_TType == 'Standard Poll') {
    var TotalSoft_Poll_1_MW = jQuery('#TotalSoft_Poll_1_MW').val();
    var TotalSoft_Poll_1_Pos = jQuery('#TotalSoft_Poll_1_Pos').val();
    var TotalSoft_Poll_1_BW = jQuery('#TotalSoft_Poll_1_BW').val();
    var TotalSoft_Poll_1_BC = jQuery('#TotalSoft_Poll_1_BC').val();
    var TotalSoft_Poll_1_BR = jQuery('#TotalSoft_Poll_1_BR').val();
    var TotalSoft_Poll_1_BoxSh_Show = '';
    var TotalSoft_Poll_1_BoxSh_Type = jQuery('#TotalSoft_Poll_1_BoxSh_Type').val();
    var TotalSoft_Poll_1_BoxSh = jQuery('#TotalSoft_Poll_1_BoxSh').val();
    var TotalSoft_Poll_1_BoxShC = jQuery('#TotalSoft_Poll_1_BoxShC').val();
    var TotalSoft_Poll_1_Q_BgC = jQuery('#TotalSoft_Poll_1_Q_BgC').val();
    var TotalSoft_Poll_1_Q_C = jQuery('#TotalSoft_Poll_1_Q_C').val();
    var TotalSoft_Poll_1_Q_FS = jQuery('#TotalSoft_Poll_1_Q_FS').val();
    var TotalSoft_Poll_1_Q_FF = jQuery('#TotalSoft_Poll_1_Q_FF').val();
    var TotalSoft_Poll_1_Q_TA = jQuery('#TotalSoft_Poll_1_Q_TA').val();
    var TotalSoft_Poll_1_LAQ_W = jQuery('#TotalSoft_Poll_1_LAQ_W').val();
    var TotalSoft_Poll_1_LAQ_H = jQuery('#TotalSoft_Poll_1_LAQ_H').val();
    var TotalSoft_Poll_1_LAQ_C = jQuery('#TotalSoft_Poll_1_LAQ_C').val();
    var TotalSoft_Poll_1_LAQ_S = jQuery('#TotalSoft_Poll_1_LAQ_S').val();
    var TotalSoft_Poll_1_A_FS = jQuery('#TotalSoft_Poll_1_A_FS').val();
    var TotalSoft_Poll_1_A_CTF = jQuery('#TotalSoft_Poll_1_A_CTF').attr('checked');
    var TotalSoft_Poll_1_A_BgC = jQuery('#TotalSoft_Poll_1_A_BgC').val();
    var TotalSoft_Poll_1_A_C = jQuery('#TotalSoft_Poll_1_A_C').val();
    var TotalSoft_Poll_1_CH_CM = jQuery('#TotalSoft_Poll_1_CH_CM').attr('checked');
    var TotalSoft_Poll_1_CH_S = jQuery('#TotalSoft_Poll_1_CH_S').val();
    var TotalSoft_Poll_1_CH_TBC = jQuery('#TotalSoft_Poll_1_CH_TBC').val();
    var TotalSoft_Poll_1_CH_CBC = jQuery('#TotalSoft_Poll_1_CH_CBC').val();
    var TotalSoft_Poll_1_CH_TAC = jQuery('#TotalSoft_Poll_1_CH_TAC').val();
    var TotalSoft_Poll_1_CH_CAC = jQuery('#TotalSoft_Poll_1_CH_CAC').val();
    var TotalSoft_Poll_1_A_HBgC = jQuery('#TotalSoft_Poll_1_A_HBgC').val();
    var TotalSoft_Poll_1_A_HC = jQuery('#TotalSoft_Poll_1_A_HC').val();
    var TotalSoft_Poll_1_LAA_W = jQuery('#TotalSoft_Poll_1_LAA_W').val();
    var TotalSoft_Poll_1_LAA_H = jQuery('#TotalSoft_Poll_1_LAA_H').val();
    var TotalSoft_Poll_1_LAA_C = jQuery('#TotalSoft_Poll_1_LAA_C').val();
    var TotalSoft_Poll_1_LAA_S = jQuery('#TotalSoft_Poll_1_LAA_S').val();
    var TotalSoft_Poll_1_VB_MBgC = jQuery('#TotalSoft_Poll_1_VB_MBgC').val();
    var TotalSoft_Poll_1_VB_Pos = jQuery('#TotalSoft_Poll_1_VB_Pos').val();
    var TotalSoft_Poll_1_VB_BW = jQuery('#TotalSoft_Poll_1_VB_BW').val();
    var TotalSoft_Poll_1_VB_BC = jQuery('#TotalSoft_Poll_1_VB_BC').val();
    var TotalSoft_Poll_1_VB_BR = jQuery('#TotalSoft_Poll_1_VB_BR').val();
    var TotalSoft_Poll_1_VB_BgC = jQuery('#TotalSoft_Poll_1_VB_BgC').val();
    var TotalSoft_Poll_1_VB_C = jQuery('#TotalSoft_Poll_1_VB_C').val();
    var TotalSoft_Poll_1_VB_FS = jQuery('#TotalSoft_Poll_1_VB_FS').val();
    var TotalSoft_Poll_1_VB_FF = jQuery('#TotalSoft_Poll_1_VB_FF').val();
    var TotalSoft_Poll_1_VB_Text = jQuery('#TotalSoft_Poll_1_VB_Text').val();
    var TotalSoft_Poll_1_VB_IT = jQuery('#TotalSoft_Poll_1_VB_IT').val();
    var TotalSoft_Poll_1_VB_IA = jQuery('#TotalSoft_Poll_1_VB_IA').val();
    var TotalSoft_Poll_1_VB_IS = jQuery('#TotalSoft_Poll_1_VB_IS').val();
    var TotalSoft_Poll_1_VB_HBgC = jQuery('#TotalSoft_Poll_1_VB_HBgC').val();
    var TotalSoft_Poll_1_VB_HC = jQuery('#TotalSoft_Poll_1_VB_HC').val();
    var TotalSoft_Poll_1_RB_Show = jQuery('#TotalSoft_Poll_1_RB_Show').attr('checked');
    var TotalSoft_Poll_1_RB_Pos = jQuery('#TotalSoft_Poll_1_RB_Pos').val();
    var TotalSoft_Poll_1_RB_BW = jQuery('#TotalSoft_Poll_1_RB_BW').val();
    var TotalSoft_Poll_1_RB_BC = jQuery('#TotalSoft_Poll_1_RB_BC').val();
    var TotalSoft_Poll_1_RB_BR = jQuery('#TotalSoft_Poll_1_RB_BR').val();
    var TotalSoft_Poll_1_RB_BgC = jQuery('#TotalSoft_Poll_1_RB_BgC').val();
    var TotalSoft_Poll_1_RB_C = jQuery('#TotalSoft_Poll_1_RB_C').val();
    var TotalSoft_Poll_1_RB_FS = jQuery('#TotalSoft_Poll_1_RB_FS').val();
    var TotalSoft_Poll_1_RB_FF = jQuery('#TotalSoft_Poll_1_RB_FF').val();
    var TotalSoft_Poll_1_RB_Text = jQuery('#TotalSoft_Poll_1_RB_Text').val();
    var TotalSoft_Poll_1_RB_IT = jQuery('#TotalSoft_Poll_1_RB_IT').val();
    var TotalSoft_Poll_1_RB_IA = jQuery('#TotalSoft_Poll_1_RB_IA').val();
    var TotalSoft_Poll_1_RB_IS = jQuery('#TotalSoft_Poll_1_RB_IS').val();
    var TotalSoft_Poll_1_RB_HBgC = jQuery('#TotalSoft_Poll_1_RB_HBgC').val();
    var TotalSoft_Poll_1_RB_HC = jQuery('#TotalSoft_Poll_1_RB_HC').val();
    var TotalSoft_Poll_1_P_BW = jQuery('#TotalSoft_Poll_1_P_BW').val();
    var TotalSoft_Poll_1_P_BC = jQuery('#TotalSoft_Poll_1_P_BC').val();
    var TotalSoft_Poll_1_P_ShPop = jQuery('#TotalSoft_Poll_1_P_ShPop').attr('checked');
    var TotalSoft_Poll_1_P_ShEff = jQuery('#TotalSoft_Poll_1_P_ShEff').val();
    var TotalSoft_Poll_1_P_Q_BgC = jQuery('#TotalSoft_Poll_1_P_Q_BgC').val();
    var TotalSoft_Poll_1_P_Q_C = jQuery('#TotalSoft_Poll_1_P_Q_C').val();
    var TotalSoft_Poll_1_P_LAQ_W = jQuery('#TotalSoft_Poll_1_P_LAQ_W').val();
    var TotalSoft_Poll_1_P_LAQ_H = jQuery('#TotalSoft_Poll_1_P_LAQ_H').val();
    var TotalSoft_Poll_1_P_LAQ_C = jQuery('#TotalSoft_Poll_1_P_LAQ_C').val();
    var TotalSoft_Poll_1_P_LAQ_S = jQuery('#TotalSoft_Poll_1_P_LAQ_S').val();
    var TotalSoft_Poll_1_P_A_BgC = jQuery('#TotalSoft_Poll_1_P_A_BgC').val();
    var TotalSoft_Poll_1_P_A_C = jQuery('#TotalSoft_Poll_1_P_A_C').val();
    var TotalSoft_Poll_1_P_A_VT = jQuery('#TotalSoft_Poll_1_P_A_VT').val();
    var TotalSoft_Poll_1_P_A_VC = jQuery('#TotalSoft_Poll_1_P_A_VC').val();
    var TotalSoft_Poll_1_P_A_VEff = jQuery('#TotalSoft_Poll_1_P_A_VEff').val();
    var TotalSoft_Poll_1_P_LAA_W = jQuery('#TotalSoft_Poll_1_P_LAA_W').val();
    var TotalSoft_Poll_1_P_LAA_H = jQuery('#TotalSoft_Poll_1_P_LAA_H').val();
    var TotalSoft_Poll_1_P_LAA_C = jQuery('#TotalSoft_Poll_1_P_LAA_C').val();
    var TotalSoft_Poll_1_P_LAA_S = jQuery('#TotalSoft_Poll_1_P_LAA_S').val();
    var TotalSoft_Poll_1_P_BB_Pos = jQuery('#TotalSoft_Poll_1_P_BB_Pos').val();
    var TotalSoft_Poll_1_P_BB_BC = jQuery('#TotalSoft_Poll_1_P_BB_BC').val();
    var TotalSoft_Poll_1_P_BB_BgC = jQuery('#TotalSoft_Poll_1_P_BB_BgC').val();
    var TotalSoft_Poll_1_P_BB_C = jQuery('#TotalSoft_Poll_1_P_BB_C').val();
    var TotalSoft_Poll_1_P_BB_Text = jQuery('#TotalSoft_Poll_1_P_BB_Text').val();
    var TotalSoft_Poll_1_P_BB_IT = jQuery('#TotalSoft_Poll_1_P_BB_IT').val();
    var TotalSoft_Poll_1_P_BB_IA = jQuery('#TotalSoft_Poll_1_P_BB_IA').val();
    var TotalSoft_Poll_1_P_BB_HBgC = jQuery('#TotalSoft_Poll_1_P_BB_HBgC').val();
    var TotalSoft_Poll_1_P_BB_HC = jQuery('#TotalSoft_Poll_1_P_BB_HC').val();
    var TotalSoft_Poll_1_P_BB_MBgC = jQuery('#TotalSoft_Poll_1_P_BB_MBgC').val();
    var TotalSoft_Poll_1_P_A_MBgC = jQuery('#TotalSoft_Poll_1_P_A_MBgC').val();
    var TotalSoft_Poll_1_A_MBgC = jQuery('#TotalSoft_Poll_1_A_MBgC').val();

    if (TotalSoft_Poll_1_A_CTF == 'checked') {
      TotalSoft_Poll_1_A_CTF = 'true';
    } else {
      TotalSoft_Poll_1_A_CTF = 'false';
    }
    if (TotalSoft_Poll_1_CH_CM == 'checked') {
      TotalSoft_Poll_1_CH_CM = 'true';
    } else {
      TotalSoft_Poll_1_CH_CM = 'false';
    }
    if (TotalSoft_Poll_1_RB_Show == 'checked') {
      TotalSoft_Poll_1_RB_Show = 'true';
    } else {
      TotalSoft_Poll_1_RB_Show = 'false';
    }
    if (TotalSoft_Poll_1_P_ShPop == 'checked') {
      TotalSoft_Poll_1_P_ShPop = 'true';
    } else {
      TotalSoft_Poll_1_P_ShPop = 'false';
    }
    ...
    var TotalSoft_Poll_2_MW = jQuery('#TotalSoft_Poll_2_MW').val();
    var TotalSoft_Poll_2_Pos = jQuery('#TotalSoft_Poll_2_Pos').val();
    var TotalSoft_Poll_2_BW = jQuery('#TotalSoft_Poll_2_BW').val();
    var TotalSoft_Poll_2_BC = jQuery('#TotalSoft_Poll_2_BC').val();
    var TotalSoft_Poll_2_BR = jQuery('#TotalSoft_Poll_2_BR').val();
    var TotalSoft_Poll_2_BoxSh_Show = '';
    var TotalSoft_Poll_2_BoxSh_Type = jQuery('#TotalSoft_Poll_2_BoxSh_Type').val();
    var TotalSoft_Poll_2_BoxSh = jQuery('#TotalSoft_Poll_2_BoxSh').val();
    var TotalSoft_Poll_2_BoxShC = jQuery('#TotalSoft_Poll_2_BoxShC').val();
    var TotalSoft_Poll_2_Q_BgC = jQuery('#TotalSoft_Poll_2_Q_BgC').val();
    var TotalSoft_Poll_2_Q_C = jQuery('#TotalSoft_Poll_2_Q_C').val();
    var TotalSoft_Poll_2_Q_FS = jQuery('#TotalSoft_Poll_2_Q_FS').val();
    var TotalSoft_Poll_2_Q_FF = jQuery('#TotalSoft_Poll_2_Q_FF').val();
    var TotalSoft_Poll_2_Q_TA = jQuery('#TotalSoft_Poll_2_Q_TA').val();
    var TotalSoft_Poll_2_LAQ_W = jQuery('#TotalSoft_Poll_2_LAQ_W').val();
    var TotalSoft_Poll_2_LAQ_H = jQuery('#TotalSoft_Poll_2_LAQ_H').val();
    var TotalSoft_Poll_2_LAQ_C = jQuery('#TotalSoft_Poll_2_LAQ_C').val();
    var TotalSoft_Poll_2_LAQ_S = jQuery('#TotalSoft_Poll_2_LAQ_S').val();
    var TotalSoft_Poll_2_A_CC = jQuery('#TotalSoft_Poll_2_A_CC').val();
    var TotalSoft_Poll_2_A_CA = jQuery('#TotalSoft_Poll_2_A_CA').val();
    var TotalSoft_Poll_2_A_FS = jQuery('#TotalSoft_Poll_2_A_FS').val();
    var TotalSoft_Poll_2_A_MBgC = jQuery('#TotalSoft_Poll_2_A_MBgC').val();
    var TotalSoft_Poll_2_A_BgC = jQuery('#TotalSoft_Poll_2_A_BgC').val();
    var TotalSoft_Poll_2_A_C = jQuery('#TotalSoft_Poll_2_A_C').val();
    var TotalSoft_Poll_2_A_Pos = jQuery('#TotalSoft_Poll_2_A_Pos').val();
    var TotalSoft_Poll_2_CH_CM = jQuery('#TotalSoft_Poll_2_CH_CM').attr('checked');
    var TotalSoft_Poll_2_CH_S = jQuery('#TotalSoft_Poll_2_CH_S').val();
    var TotalSoft_Poll_2_CH_TBC = jQuery('#TotalSoft_Poll_2_CH_TBC').val();
    var TotalSoft_Poll_2_CH_CBC = jQuery('#TotalSoft_Poll_2_CH_CBC').val();
    var TotalSoft_Poll_2_CH_TAC = jQuery('#TotalSoft_Poll_2_CH_TAC').val();
    var TotalSoft_Poll_2_CH_CAC = jQuery('#TotalSoft_Poll_2_CH_CAC').val();
    var TotalSoft_Poll_2_A_HBgC = jQuery('#TotalSoft_Poll_2_A_HBgC').val();
    var TotalSoft_Poll_2_A_HC = jQuery('#TotalSoft_Poll_2_A_HC').val();
    var TotalSoft_Poll_2_A_HSh_Show = jQuery('#TotalSoft_Poll_2_A_HSh_Show').attr('checked');
    var TotalSoft_Poll_2_A_HShC = jQuery('#TotalSoft_Poll_2_A_HShC').val();
    var TotalSoft_Poll_2_LAA_W = jQuery('#TotalSoft_Poll_2_LAA_W').val();
    var TotalSoft_Poll_2_LAA_H = jQuery('#TotalSoft_Poll_2_LAA_H').val();
    var TotalSoft_Poll_2_LAA_C = jQuery('#TotalSoft_Poll_2_LAA_C').val();
    var TotalSoft_Poll_2_LAA_S = jQuery('#TotalSoft_Poll_2_LAA_S').val();
    var TotalSoft_Poll_2_P_A_OC = jQuery('#TotalSoft_Poll_2_P_A_OC').val();
    var TotalSoft_Poll_2_P_A_C = jQuery('#TotalSoft_Poll_2_P_A_C').val();
    var TotalSoft_Poll_2_P_A_VT = jQuery('#TotalSoft_Poll_2_P_A_VT').val();
    var TotalSoft_Poll_2_P_A_VEff = jQuery('#TotalSoft_Poll_2_P_A_VEff').val();
    var TotalSoft_Poll_2_VB_MBgC = jQuery('#TotalSoft_Poll_2_VB_MBgC').val();
    var TotalSoft_Poll_2_VB_Pos = jQuery('#TotalSoft_Poll_2_VB_Pos').val();
    var TotalSoft_Poll_2_VB_BW = jQuery('#TotalSoft_Poll_2_VB_BW').val();
    var TotalSoft_Poll_2_VB_BC = jQuery('#TotalSoft_Poll_2_VB_BC').val();
    var TotalSoft_Poll_2_Play_IC = jQuery('#TotalSoft_Poll_2_Play_IC').val();
    var TotalSoft_Poll_2_Play_IS = jQuery('#TotalSoft_Poll_2_Play_IS').val();
    var TotalSoft_Poll_2_Play_IOvC = jQuery('#TotalSoft_Poll_2_Play_IOvC').val();
    var TotalSoft_Poll_2_Play_IT = jQuery('#TotalSoft_Poll_2_Play_IT').val();
    var TotalSoft_Poll_2_VB_BR = jQuery('#TotalSoft_Poll_2_VB_BR').val();
    var TotalSoft_Poll_2_VB_BgC = jQuery('#TotalSoft_Poll_2_VB_BgC').val();
    var TotalSoft_Poll_2_VB_C = jQuery('#TotalSoft_Poll_2_VB_C').val();
    var TotalSoft_Poll_2_VB_FS = jQuery('#TotalSoft_Poll_2_VB_FS').val();
    var TotalSoft_Poll_2_VB_FF = jQuery('#TotalSoft_Poll_2_VB_FF').val();
    var TotalSoft_Poll_2_VB_Text = jQuery('#TotalSoft_Poll_2_VB_Text').val();
    var TotalSoft_Poll_2_VB_IT = jQuery('#TotalSoft_Poll_2_VB_IT').val();
    var TotalSoft_Poll_2_VB_IA = jQuery('#TotalSoft_Poll_2_VB_IA').val();
    var TotalSoft_Poll_2_VB_IS = jQuery('#TotalSoft_Poll_2_VB_IS').val();
    var TotalSoft_Poll_2_VB_HBgC = jQuery('#TotalSoft_Poll_2_VB_HBgC').val();
    var TotalSoft_Poll_2_VB_HC = jQuery('#TotalSoft_Poll_2_VB_HC').val();
    var TotalSoft_Poll_2_RB_Show = jQuery('#TotalSoft_Poll_2_RB_Show').attr('checked');
    var TotalSoft_Poll_2_RB_Pos = jQuery('#TotalSoft_Poll_2_RB_Pos').val();
    var TotalSoft_Poll_2_RB_BW = jQuery('#TotalSoft_Poll_2_RB_BW').val();
    var TotalSoft_Poll_2_RB_BC = jQuery('#TotalSoft_Poll_2_RB_BC').val();
    var TotalSoft_Poll_2_RB_BR = jQuery('#TotalSoft_Poll_2_RB_BR').val();
    var TotalSoft_Poll_2_RB_BgC = jQuery('#TotalSoft_Poll_2_RB_BgC').val();
    var TotalSoft_Poll_2_RB_C = jQuery('#TotalSoft_Poll_2_RB_C').val();
    var TotalSoft_Poll_2_RB_FS = jQuery('#TotalSoft_Poll_2_RB_FS').val();
    var TotalSoft_Poll_2_RB_FF = jQuery('#TotalSoft_Poll_2_RB_FF').val();
    var TotalSoft_Poll_2_RB_Text = jQuery('#TotalSoft_Poll_2_RB_Text').val();
    var TotalSoft_Poll_2_RB_IT = jQuery('#TotalSoft_Poll_2_RB_IT').val();
    var TotalSoft_Poll_2_RB_IA = jQuery('#TotalSoft_Poll_2_RB_IA').val();
    var TotalSoft_Poll_2_RB_IS = jQuery('#TotalSoft_Poll_2_RB_IS').val();
    var TotalSoft_Poll_2_RB_HBgC = jQuery('#TotalSoft_Poll_2_RB_HBgC').val();
    var TotalSoft_Poll_2_RB_HC = jQuery('#TotalSoft_Poll_2_RB_HC').val();
    var TotalSoft_Poll_2_P_BB_MBgC = jQuery('#TotalSoft_Poll_2_P_BB_MBgC').val();
    var TotalSoft_Poll_2_P_BB_Pos = jQuery('#TotalSoft_Poll_2_P_BB_Pos').val();
    var TotalSoft_Poll_2_P_BB_BC = jQuery('#TotalSoft_Poll_2_P_BB_BC').val();
    var TotalSoft_Poll_2_P_BB_BgC = jQuery('#TotalSoft_Poll_2_P_BB_BgC').val();
    var TotalSoft_Poll_2_P_BB_C = jQuery('#TotalSoft_Poll_2_P_BB_C').val();
    var TotalSoft_Poll_2_P_BB_Text = jQuery('#TotalSoft_Poll_2_P_BB_Text').val();
    var TotalSoft_Poll_2_P_BB_IT = jQuery('#TotalSoft_Poll_2_P_BB_IT').val();
    var TotalSoft_Poll_2_P_BB_IA = jQuery('#TotalSoft_Poll_2_P_BB_IA').val();
    var TotalSoft_Poll_2_P_BB_HBgC = jQuery('#TotalSoft_Poll_2_P_BB_HBgC').val();
    var TotalSoft_Poll_2_P_BB_HC = jQuery('#TotalSoft_Poll_2_P_BB_HC').val();
    var TotalSoft_Poll_2_A_IHT = jQuery('#TotalSoft_Poll_2_A_IHT').val();

    if (TotalSoft_Poll_2_A_IHT == 'fixed') {
      var TotalSoft_Poll_2_A_IH = jQuery('#TotalSoft_Poll_2_A_IH').val();
    } else {
      var TotalSoft_Poll_2_A_IH = jQuery('#TotalSoft_Poll_2_A_IHR').val();
    }
    if (TotalSoft_Poll_2_CH_CM == 'checked') {
      TotalSoft_Poll_2_CH_CM = 'true';
    } else {
      TotalSoft_Poll_2_CH_CM = 'false';
    }
    if (TotalSoft_Poll_2_A_HSh_Show == 'checked') {
      TotalSoft_Poll_2_A_HSh_Show = 'true';
    } else {
      TotalSoft_Poll_2_A_HSh_Show = 'false';
    }
    if (TotalSoft_Poll_2_RB_Show == 'checked') {
      TotalSoft_Poll_2_RB_Show = 'true';
    } else {
      TotalSoft_Poll_2_RB_Show = 'false';
    }
    ...
    var TotalSoft_Poll_3_MW = jQuery('#TotalSoft_Poll_3_MW').val();
    var TotalSoft_Poll_3_Pos = jQuery('#TotalSoft_Poll_3_Pos').val();
    var TotalSoft_Poll_3_BW = jQuery('#TotalSoft_Poll_3_BW').val();
    var TotalSoft_Poll_3_BC = jQuery('#TotalSoft_Poll_3_BC').val();
    var TotalSoft_Poll_3_BR = jQuery('#TotalSoft_Poll_3_BR').val();
    var TotalSoft_Poll_3_BoxSh_Show = '';
    var TotalSoft_Poll_3_BoxSh_Type = jQuery('#TotalSoft_Poll_3_BoxSh_Type').val();
    var TotalSoft_Poll_3_BoxSh = jQuery('#TotalSoft_Poll_3_BoxSh').val();
    var TotalSoft_Poll_3_BoxShC = jQuery('#TotalSoft_Poll_3_BoxShC').val();
    var TotalSoft_Poll_3_Q_BgC = jQuery('#TotalSoft_Poll_3_Q_BgC').val();
    var TotalSoft_Poll_3_Q_C = jQuery('#TotalSoft_Poll_3_Q_C').val();
    var TotalSoft_Poll_3_Q_FS = jQuery('#TotalSoft_Poll_3_Q_FS').val();
    var TotalSoft_Poll_3_Q_FF = jQuery('#TotalSoft_Poll_3_Q_FF').val();
    var TotalSoft_Poll_3_Q_TA = jQuery('#TotalSoft_Poll_3_Q_TA').val();
    var TotalSoft_Poll_3_LAQ_W = jQuery('#TotalSoft_Poll_3_LAQ_W').val();
    var TotalSoft_Poll_3_LAQ_H = jQuery('#TotalSoft_Poll_3_LAQ_H').val();
    var TotalSoft_Poll_3_LAQ_C = jQuery('#TotalSoft_Poll_3_LAQ_C').val();
    var TotalSoft_Poll_3_LAQ_S = jQuery('#TotalSoft_Poll_3_LAQ_S').val();
    var TotalSoft_Poll_3_A_CA = jQuery('#TotalSoft_Poll_3_A_CA').val();
    var TotalSoft_Poll_3_A_FS = jQuery('#TotalSoft_Poll_3_A_FS').val();
    var TotalSoft_Poll_3_A_MBgC = jQuery('#TotalSoft_Poll_3_A_MBgC').val();
    var TotalSoft_Poll_3_A_BgC = jQuery('#TotalSoft_Poll_3_A_BgC').val();
    var TotalSoft_Poll_3_A_C = jQuery('#TotalSoft_Poll_3_A_C').val();
    var TotalSoft_Poll_3_A_BW = jQuery('#TotalSoft_Poll_3_A_BW').val();
    var TotalSoft_Poll_3_A_BC = jQuery('#TotalSoft_Poll_3_A_BC').val();
    var TotalSoft_Poll_3_A_BR = jQuery('#TotalSoft_Poll_3_A_BR').val();
    var TotalSoft_Poll_3_CH_Sh = jQuery('#TotalSoft_Poll_3_CH_Sh').attr('checked');
    var TotalSoft_Poll_3_CH_S = jQuery('#TotalSoft_Poll_3_CH_S').val();
    var TotalSoft_Poll_3_CH_TBC = jQuery('#TotalSoft_Poll_3_CH_TBC').val();
    var TotalSoft_Poll_3_CH_CBC = jQuery('#TotalSoft_Poll_3_CH_CBC').val();
    var TotalSoft_Poll_3_CH_TAC = jQuery('#TotalSoft_Poll_3_CH_TAC').val();
    var TotalSoft_Poll_3_CH_CAC = jQuery('#TotalSoft_Poll_3_CH_CAC').val();
    var TotalSoft_Poll_3_A_HBgC = jQuery('#TotalSoft_Poll_3_A_HBgC').val();
    var TotalSoft_Poll_3_A_HC = jQuery('#TotalSoft_Poll_3_A_HC').val();
    var TotalSoft_Poll_3_LAA_W = jQuery('#TotalSoft_Poll_3_LAA_W').val();
    var TotalSoft_Poll_3_LAA_H = jQuery('#TotalSoft_Poll_3_LAA_H').val();
    var TotalSoft_Poll_3_LAA_C = jQuery('#TotalSoft_Poll_3_LAA_C').val();
    var TotalSoft_Poll_3_LAA_S = jQuery('#TotalSoft_Poll_3_LAA_S').val();
    var TotalSoft_Poll_3_RB_MBgC = jQuery('#TotalSoft_Poll_3_RB_MBgC').val();
    var TotalSoft_Poll_3_TV_Show = jQuery('#TotalSoft_Poll_3_TV_Show').attr('checked');
    var TotalSoft_Poll_3_TV_Pos = jQuery('#TotalSoft_Poll_3_TV_Pos').val();
    var TotalSoft_Poll_3_TV_C = jQuery('#TotalSoft_Poll_3_TV_C').val();
    var TotalSoft_Poll_3_TV_FS = jQuery('#TotalSoft_Poll_3_TV_FS').val();
    var TotalSoft_Poll_3_TV_Text = jQuery('#TotalSoft_Poll_3_TV_Text').val();
    var TotalSoft_Poll_3_VT_IT = jQuery('#TotalSoft_Poll_3_VT_IT').val();
    var TotalSoft_Poll_3_RB_Show = jQuery('#TotalSoft_Poll_3_RB_Show').attr('checked');
    var TotalSoft_Poll_3_RB_Pos = jQuery('#TotalSoft_Poll_3_RB_Pos').val();
    var TotalSoft_Poll_3_RB_BW = jQuery('#TotalSoft_Poll_3_RB_BW').val();
    var TotalSoft_Poll_3_RB_BC = jQuery('#TotalSoft_Poll_3_RB_BC').val();
    var TotalSoft_Poll_3_RB_BR = jQuery('#TotalSoft_Poll_3_RB_BR').val();
    var TotalSoft_Poll_3_RB_BgC = jQuery('#TotalSoft_Poll_3_RB_BgC').val();
    var TotalSoft_Poll_3_RB_C = jQuery('#TotalSoft_Poll_3_RB_C').val();
    var TotalSoft_Poll_3_RB_FS = jQuery('#TotalSoft_Poll_3_RB_FS').val();
    var TotalSoft_Poll_3_RB_FF = jQuery('#TotalSoft_Poll_3_RB_FF').val();
    var TotalSoft_Poll_3_RB_Text = jQuery('#TotalSoft_Poll_3_RB_Text').val();
    var TotalSoft_Poll_3_RB_IT = jQuery('#TotalSoft_Poll_3_RB_IT').val();
    var TotalSoft_Poll_3_RB_IA = jQuery('#TotalSoft_Poll_3_RB_IA').val();
    var TotalSoft_Poll_3_RB_IS = jQuery('#TotalSoft_Poll_3_RB_IS').val();
    var TotalSoft_Poll_3_RB_HBgC = jQuery('#TotalSoft_Poll_3_RB_HBgC').val();
    var TotalSoft_Poll_3_RB_HC = jQuery('#TotalSoft_Poll_3_RB_HC').val();
    var TotalSoft_Poll_3_V_CA = jQuery('#TotalSoft_Poll_3_V_CA').val();
    var TotalSoft_Poll_3_V_MBgC = jQuery('#TotalSoft_Poll_3_V_MBgC').val();
    var TotalSoft_Poll_3_V_BgC = jQuery('#TotalSoft_Poll_3_V_BgC').val();
    var TotalSoft_Poll_3_V_C = jQuery('#TotalSoft_Poll_3_V_C').val();
    var TotalSoft_Poll_3_V_T = jQuery('#TotalSoft_Poll_3_V_T').val();
    var TotalSoft_Poll_3_V_Eff = jQuery('#TotalSoft_Poll_3_V_Eff').val();
    var TotalSoft_Poll_3_BB_MBgC = jQuery('#TotalSoft_Poll_3_BB_MBgC').val();
    var TotalSoft_Poll_3_BB_Pos = jQuery('#TotalSoft_Poll_3_BB_Pos').val();
    var TotalSoft_Poll_3_BB_BC = jQuery('#TotalSoft_Poll_3_BB_BC').val();
    var TotalSoft_Poll_3_BB_BgC = jQuery('#TotalSoft_Poll_3_BB_BgC').val();
    var TotalSoft_Poll_3_BB_C = jQuery('#TotalSoft_Poll_3_BB_C').val();
    var TotalSoft_Poll_3_BB_Text = jQuery('#TotalSoft_Poll_3_BB_Text').val();
    var TotalSoft_Poll_3_BB_IT = jQuery('#TotalSoft_Poll_3_BB_IT').val();
    var TotalSoft_Poll_3_BB_IA = jQuery('#TotalSoft_Poll_3_BB_IA').val();
    var TotalSoft_Poll_3_BB_HBgC = jQuery('#TotalSoft_Poll_3_BB_HBgC').val();
    var TotalSoft_Poll_3_BB_HC = jQuery('#TotalSoft_Poll_3_BB_HC').val();
    var TotalSoft_Poll_3_VT_IA = jQuery('#TotalSoft_Poll_3_VT_IA').val();

    if (TotalSoft_Poll_3_CH_Sh == 'checked') {
      TotalSoft_Poll_3_CH_Sh = 'true';
    } else {
      TotalSoft_Poll_3_CH_Sh = 'false';
    }
    if (TotalSoft_Poll_3_TV_Show == 'checked') {
      TotalSoft_Poll_3_TV_Show = 'true';
    } else {
      TotalSoft_Poll_3_TV_Show = 'false';
    }
    if (TotalSoft_Poll_3_RB_Show == 'checked') {
      TotalSoft_Poll_3_RB_Show = 'true';
    } else {
    ...
    var TotalSoft_Poll_4_MW = jQuery('#TotalSoft_Poll_4_MW').val();
    var TotalSoft_Poll_4_Pos = jQuery('#TotalSoft_Poll_4_Pos').val();
    var TotalSoft_Poll_4_BW = jQuery('#TotalSoft_Poll_4_BW').val();
    var TotalSoft_Poll_4_BC = jQuery('#TotalSoft_Poll_4_BC').val();
    var TotalSoft_Poll_4_BR = jQuery('#TotalSoft_Poll_4_BR').val();
    var TotalSoft_Poll_4_BoxSh_Show = '';
    var TotalSoft_Poll_4_BoxSh_Type = jQuery('#TotalSoft_Poll_4_BoxSh_Type').val();
    var TotalSoft_Poll_4_BoxSh = '';
    var TotalSoft_Poll_4_BoxShC = jQuery('#TotalSoft_Poll_4_BoxShC').val();
    var TotalSoft_Poll_4_Q_BgC = jQuery('#TotalSoft_Poll_4_Q_BgC').val();
    var TotalSoft_Poll_4_Q_C = jQuery('#TotalSoft_Poll_4_Q_C').val();
    var TotalSoft_Poll_4_Q_FS = jQuery('#TotalSoft_Poll_4_Q_FS').val();
    var TotalSoft_Poll_4_Q_FF = jQuery('#TotalSoft_Poll_4_Q_FF').val();
    var TotalSoft_Poll_4_Q_TA = jQuery('#TotalSoft_Poll_4_Q_TA').val();
    var TotalSoft_Poll_4_LAQ_W = jQuery('#TotalSoft_Poll_4_LAQ_W').val();
    var TotalSoft_Poll_4_LAQ_H = jQuery('#TotalSoft_Poll_4_LAQ_H').val();
    var TotalSoft_Poll_4_LAQ_C = jQuery('#TotalSoft_Poll_4_LAQ_C').val();
    var TotalSoft_Poll_4_LAQ_S = jQuery('#TotalSoft_Poll_4_LAQ_S').val();
    var TotalSoft_Poll_4_A_CA = jQuery('#TotalSoft_Poll_4_A_CA').val();
    var TotalSoft_Poll_4_A_FS = jQuery('#TotalSoft_Poll_4_A_FS').val();
    var TotalSoft_Poll_4_A_MBgC = jQuery('#TotalSoft_Poll_4_A_MBgC').val();
    var TotalSoft_Poll_4_A_BgC = jQuery('#TotalSoft_Poll_4_A_BgC').val();
    var TotalSoft_Poll_4_A_C = jQuery('#TotalSoft_Poll_4_A_C').val();
    var TotalSoft_Poll_4_A_BW = jQuery('#TotalSoft_Poll_4_A_BW').val();
    var TotalSoft_Poll_4_A_BC = jQuery('#TotalSoft_Poll_4_A_BC').val();
    var TotalSoft_Poll_4_A_BR = jQuery('#TotalSoft_Poll_4_A_BR').val();
    var TotalSoft_Poll_4_A_FF = jQuery('#TotalSoft_Poll_4_A_FF').val();
    var TotalSoft_Poll_4_A_HBgC = jQuery('#TotalSoft_Poll_4_A_HBgC').val();
    var TotalSoft_Poll_4_A_HC = jQuery('#TotalSoft_Poll_4_A_HC').val();
    var TotalSoft_Poll_4_I_H = jQuery('#TotalSoft_Poll_4_I_H').val();
    var TotalSoft_Poll_4_I_Ra = jQuery('#TotalSoft_Poll_4_I_Ra').val();
    var TotalSoft_Poll_4_I_OC = jQuery('#TotalSoft_Poll_4_I_OC').val();
    var TotalSoft_Poll_4_I_IT = jQuery('#TotalSoft_Poll_4_I_IT').val();
    var TotalSoft_Poll_4_I_IC = jQuery('#TotalSoft_Poll_4_I_IC').val();
    var TotalSoft_Poll_4_I_IS = jQuery('#TotalSoft_Poll_4_I_IS').val();
    var TotalSoft_Poll_4_Pop_Show = jQuery('#TotalSoft_Poll_4_Pop_Show').attr('checked');
    var TotalSoft_Poll_4_Pop_IT = jQuery('#TotalSoft_Poll_4_Pop_IT').val();
    var TotalSoft_Poll_4_Pop_IC = jQuery('#TotalSoft_Poll_4_Pop_IC').val();
    var TotalSoft_Poll_4_Pop_BW = jQuery('#TotalSoft_Poll_4_Pop_BW').val();
    var TotalSoft_Poll_4_Pop_BC = jQuery('#TotalSoft_Poll_4_Pop_BC').val();
    var TotalSoft_Poll_4_LAA_W = jQuery('#TotalSoft_Poll_4_LAA_W').val();
    var TotalSoft_Poll_4_LAA_H = jQuery('#TotalSoft_Poll_4_LAA_H').val();
    var TotalSoft_Poll_4_LAA_C = jQuery('#TotalSoft_Poll_4_LAA_C').val();
    var TotalSoft_Poll_4_LAA_S = jQuery('#TotalSoft_Poll_4_LAA_S').val();
    var TotalSoft_Poll_4_TV_Show = jQuery('#TotalSoft_Poll_4_TV_Show').attr('checked');
    var TotalSoft_Poll_4_TV_Pos = jQuery('#TotalSoft_Poll_4_TV_Pos').val();
    var TotalSoft_Poll_4_TV_C = jQuery('#TotalSoft_Poll_4_TV_C').val();
    var TotalSoft_Poll_4_TV_FS = jQuery('#TotalSoft_Poll_4_TV_FS').val();
    var TotalSoft_Poll_4_TV_Text = jQuery('#TotalSoft_Poll_4_TV_Text').val();
    var TotalSoft_Poll_4_VT_IT = jQuery('#TotalSoft_Poll_4_VT_IT').val();
    var TotalSoft_Poll_4_VT_IA = jQuery('#TotalSoft_Poll_4_VT_IA').val();
    var TotalSoft_Poll_4_RB_Show = jQuery('#TotalSoft_Poll_4_RB_Show').attr('checked');
    var TotalSoft_Poll_4_RB_Pos = jQuery('#TotalSoft_Poll_4_RB_Pos').val();
    var TotalSoft_Poll_4_RB_BW = jQuery('#TotalSoft_Poll_4_RB_BW').val();
    var TotalSoft_Poll_4_RB_BC = jQuery('#TotalSoft_Poll_4_RB_BC').val();
    var TotalSoft_Poll_4_RB_BR = jQuery('#TotalSoft_Poll_4_RB_BR').val();
    var TotalSoft_Poll_4_RB_MBgC = jQuery('#TotalSoft_Poll_4_RB_MBgC').val();
    var TotalSoft_Poll_4_RB_BgC = jQuery('#TotalSoft_Poll_4_RB_BgC').val();
    var TotalSoft_Poll_4_RB_C = jQuery('#TotalSoft_Poll_4_RB_C').val();
    var TotalSoft_Poll_4_RB_FS = jQuery('#TotalSoft_Poll_4_RB_FS').val();
    var TotalSoft_Poll_4_RB_FF = jQuery('#TotalSoft_Poll_4_RB_FF').val();
    var TotalSoft_Poll_4_RB_Text = jQuery('#TotalSoft_Poll_4_RB_Text').val();
    var TotalSoft_Poll_4_RB_IT = jQuery('#TotalSoft_Poll_4_RB_IT').val();
    var TotalSoft_Poll_4_RB_IA = jQuery('#TotalSoft_Poll_4_RB_IA').val();
    var TotalSoft_Poll_4_RB_IS = jQuery('#TotalSoft_Poll_4_RB_IS').val();
    var TotalSoft_Poll_4_RB_HBgC = jQuery('#TotalSoft_Poll_4_RB_HBgC').val();
    var TotalSoft_Poll_4_RB_HC = jQuery('#TotalSoft_Poll_4_RB_HC').val();
    var TotalSoft_Poll_4_V_CA = jQuery('#TotalSoft_Poll_4_V_CA').val();
    var TotalSoft_Poll_4_V_MBgC = jQuery('#TotalSoft_Poll_4_V_MBgC').val();
    var TotalSoft_Poll_4_V_BgC = jQuery('#TotalSoft_Poll_4_V_BgC').val();
    var TotalSoft_Poll_4_V_C = jQuery('#TotalSoft_Poll_4_V_C').val();
    var TotalSoft_Poll_4_V_T = jQuery('#TotalSoft_Poll_4_V_T').val();
    var TotalSoft_Poll_4_V_Eff = jQuery('#TotalSoft_Poll_4_V_Eff').val();
    var TotalSoft_Poll_4_BB_MBgC = jQuery('#TotalSoft_Poll_4_BB_MBgC').val();
    var TotalSoft_Poll_4_BB_Pos = jQuery('#TotalSoft_Poll_4_BB_Pos').val();
    var TotalSoft_Poll_4_BB_BC = jQuery('#TotalSoft_Poll_4_BB_BC').val();
    var TotalSoft_Poll_4_BB_BgC = jQuery('#TotalSoft_Poll_4_BB_BgC').val();
    var TotalSoft_Poll_4_BB_C = jQuery('#TotalSoft_Poll_4_BB_C').val();
    var TotalSoft_Poll_4_BB_Text = jQuery('#TotalSoft_Poll_4_BB_Text').val();
    var TotalSoft_Poll_4_BB_IT = jQuery('#TotalSoft_Poll_4_BB_IT').val();
    var TotalSoft_Poll_4_BB_IA = jQuery('#TotalSoft_Poll_4_BB_IA').val();
    var TotalSoft_Poll_4_BB_HBgC = jQuery('#TotalSoft_Poll_4_BB_HBgC').val();
    var TotalSoft_Poll_4_BB_HC = jQuery('#TotalSoft_Poll_4_BB_HC').val();

    if (TotalSoft_Poll_4_Pop_Show == 'checked') {
      TotalSoft_Poll_4_Pop_Show = 'true';
    } else {
      TotalSoft_Poll_4_Pop_Show = 'false';
    }
    if (TotalSoft_Poll_4_TV_Show == 'checked') {
      TotalSoft_Poll_4_TV_Show = 'true';
    } else {
      TotalSoft_Poll_4_TV_Show = 'false';
    }
    if (TotalSoft_Poll_4_RB_Show == 'checked') {
    ...
    var TotalSoft_Poll_5_MW = jQuery('#TotalSoft_Poll_5_MW').val();
    var TotalSoft_Poll_5_Pos = jQuery('#TotalSoft_Poll_5_Pos').val();
    var TotalSoft_Poll_5_BW = jQuery('#TotalSoft_Poll_5_BW').val();
    var TotalSoft_Poll_5_BC = jQuery('#TotalSoft_Poll_5_BC').val();
    var TotalSoft_Poll_5_BR = jQuery('#TotalSoft_Poll_5_BR').val();
    var TotalSoft_Poll_5_BoxSh_Show = '';
    var TotalSoft_Poll_5_BoxSh_Type = jQuery('#TotalSoft_Poll_5_BoxSh_Type').val();
    var TotalSoft_Poll_5_BoxSh = jQuery('#TotalSoft_Poll_5_BoxSh').val();
    var TotalSoft_Poll_5_BoxShC = jQuery('#TotalSoft_Poll_5_BoxShC').val();
    var TotalSoft_Poll_5_Q_BgC = jQuery('#TotalSoft_Poll_5_Q_BgC').val();
    var TotalSoft_Poll_5_Q_C = jQuery('#TotalSoft_Poll_5_Q_C').val();
    var TotalSoft_Poll_5_Q_FS = jQuery('#TotalSoft_Poll_5_Q_FS').val();
    var TotalSoft_Poll_5_Q_FF = jQuery('#TotalSoft_Poll_5_Q_FF').val();
    var TotalSoft_Poll_5_Q_TA = jQuery('#TotalSoft_Poll_5_Q_TA').val();
    var TotalSoft_Poll_5_I_H = jQuery('#TotalSoft_Poll_5_I_H').val();
    var TotalSoft_Poll_5_I_Ra = jQuery('#TotalSoft_Poll_5_I_Ra').val();
    var TotalSoft_Poll_5_V_W = jQuery('#TotalSoft_Poll_5_V_W').val();
    var TotalSoft_Poll_5_LAQ_W = jQuery('#TotalSoft_Poll_5_LAQ_W').val();
    var TotalSoft_Poll_5_LAQ_H = jQuery('#TotalSoft_Poll_5_LAQ_H').val();
    var TotalSoft_Poll_5_LAQ_C = jQuery('#TotalSoft_Poll_5_LAQ_C').val();
    var TotalSoft_Poll_5_LAQ_S = jQuery('#TotalSoft_Poll_5_LAQ_S').val();
    var TotalSoft_Poll_5_A_CA = jQuery('#TotalSoft_Poll_5_A_CA').val();
    var TotalSoft_Poll_5_A_FS = jQuery('#TotalSoft_Poll_5_A_FS').val();
    var TotalSoft_Poll_5_A_MBgC = jQuery('#TotalSoft_Poll_5_A_MBgC').val();
    var TotalSoft_Poll_5_A_BgC = jQuery('#TotalSoft_Poll_5_A_BgC').val();
    var TotalSoft_Poll_5_A_C = jQuery('#TotalSoft_Poll_5_A_C').val();
    var TotalSoft_Poll_5_A_BW = jQuery('#TotalSoft_Poll_5_A_BW').val();
    var TotalSoft_Poll_5_A_BC = jQuery('#TotalSoft_Poll_5_A_BC').val();
    var TotalSoft_Poll_5_A_BR = jQuery('#TotalSoft_Poll_5_A_BR').val();
    var TotalSoft_Poll_5_CH_S = jQuery('#TotalSoft_Poll_5_CH_S').val();
    var TotalSoft_Poll_5_CH_TBC = jQuery('#TotalSoft_Poll_5_CH_TBC').val();
    var TotalSoft_Poll_5_CH_CBC = jQuery('#TotalSoft_Poll_5_CH_CBC').val();
    var TotalSoft_Poll_5_CH_TAC = jQuery('#TotalSoft_Poll_5_CH_TAC').val();
    var TotalSoft_Poll_5_CH_CAC = jQuery('#TotalSoft_Poll_5_CH_CAC').val();
    var TotalSoft_Poll_5_A_HBgC = jQuery('#TotalSoft_Poll_5_A_HBgC').val();
    var TotalSoft_Poll_5_A_HC = jQuery('#TotalSoft_Poll_5_A_HC').val();
    var TotalSoft_Poll_5_LAA_W = jQuery('#TotalSoft_Poll_5_LAA_W').val();
    var TotalSoft_Poll_5_LAA_H = jQuery('#TotalSoft_Poll_5_LAA_H').val();
    var TotalSoft_Poll_5_LAA_C = jQuery('#TotalSoft_Poll_5_LAA_C').val();
    var TotalSoft_Poll_5_LAA_S = jQuery('#TotalSoft_Poll_5_LAA_S').val();
    var TotalSoft_Poll_5_TV_Show = jQuery('#TotalSoft_Poll_5_TV_Show').attr('checked');
    var TotalSoft_Poll_5_TV_Pos = jQuery('#TotalSoft_Poll_5_TV_Pos').val();
    var TotalSoft_Poll_5_TV_C = jQuery('#TotalSoft_Poll_5_TV_C').val();
    var TotalSoft_Poll_5_TV_FS = jQuery('#TotalSoft_Poll_5_TV_FS').val();
    var TotalSoft_Poll_5_VT_IT = jQuery('#TotalSoft_Poll_5_VT_IT').val();
    var TotalSoft_Poll_5_VT_IA = jQuery('#TotalSoft_Poll_5_VT_IA').val();
    var TotalSoft_Poll_5_VB_Show = jQuery('#TotalSoft_Poll_5_VB_Show').attr('checked');
    var TotalSoft_Poll_5_VB_Pos = jQuery('#TotalSoft_Poll_5_VB_Pos').val();
    var TotalSoft_Poll_5_VB_BW = jQuery('#TotalSoft_Poll_5_VB_BW').val();
    var TotalSoft_Poll_5_VB_BC = jQuery('#TotalSoft_Poll_5_VB_BC').val();
    var TotalSoft_Poll_5_VB_BR = jQuery('#TotalSoft_Poll_5_VB_BR').val();
    var TotalSoft_Poll_5_VB_MBgC = jQuery('#TotalSoft_Poll_5_VB_MBgC').val();
    var TotalSoft_Poll_5_VB_BgC = jQuery('#TotalSoft_Poll_5_VB_BgC').val();
    var TotalSoft_Poll_5_VB_C = jQuery('#TotalSoft_Poll_5_VB_C').val();
    var TotalSoft_Poll_5_VB_FS = jQuery('#TotalSoft_Poll_5_VB_FS').val();
    var TotalSoft_Poll_5_VB_FF = jQuery('#TotalSoft_Poll_5_VB_FF').val();
    var TotalSoft_Poll_5_VB_IT = jQuery('#TotalSoft_Poll_5_VB_IT').val();
    var TotalSoft_Poll_5_VB_IA = jQuery('#TotalSoft_Poll_5_VB_IA').val();
    var TotalSoft_Poll_5_VB_IS = jQuery('#TotalSoft_Poll_5_VB_IS').val();
    var TotalSoft_Poll_5_VB_HBgC = jQuery('#TotalSoft_Poll_5_VB_HBgC').val();
    var TotalSoft_Poll_5_VB_HC = jQuery('#TotalSoft_Poll_5_VB_HC').val();
    var TotalSoft_Poll_5_RB_Show = jQuery('#TotalSoft_Poll_5_RB_Show').attr('checked');
    var TotalSoft_Poll_5_RB_Pos = jQuery('#TotalSoft_Poll_5_RB_Pos').val();
    var TotalSoft_Poll_5_RB_BW = jQuery('#TotalSoft_Poll_5_RB_BW').val();
    var TotalSoft_Poll_5_RB_BC = jQuery('#TotalSoft_Poll_5_RB_BC').val();
    var TotalSoft_Poll_5_RB_BR = jQuery('#TotalSoft_Poll_5_RB_BR').val();
    var TotalSoft_Poll_5_RB_BgC = jQuery('#TotalSoft_Poll_5_RB_BgC').val();
    var TotalSoft_Poll_5_RB_C = jQuery('#TotalSoft_Poll_5_RB_C').val();
    var TotalSoft_Poll_5_RB_FS = jQuery('#TotalSoft_Poll_5_RB_FS').val();
    var TotalSoft_Poll_5_RB_FF = jQuery('#TotalSoft_Poll_5_RB_FF').val();
    var TotalSoft_Poll_5_RB_IT = jQuery('#TotalSoft_Poll_5_RB_IT').val();
    var TotalSoft_Poll_5_RB_IA = jQuery('#TotalSoft_Poll_5_RB_IA').val();
    var TotalSoft_Poll_5_RB_IS = jQuery('#TotalSoft_Poll_5_RB_IS').val();
    var TotalSoft_Poll_5_RB_HBgC = jQuery('#TotalSoft_Poll_5_RB_HBgC').val();
    var TotalSoft_Poll_5_RB_HC = jQuery('#TotalSoft_Poll_5_RB_HC').val();
    var TotalSoft_Poll_5_V_CA = jQuery('#TotalSoft_Poll_5_V_CA').val();
    var TotalSoft_Poll_5_V_MBgC = jQuery('#TotalSoft_Poll_5_V_MBgC').val();
    var TotalSoft_Poll_5_V_BgC = jQuery('#TotalSoft_Poll_5_V_BgC').val();
    var TotalSoft_Poll_5_V_C = jQuery('#TotalSoft_Poll_5_V_C').val();
    var TotalSoft_Poll_5_V_T = jQuery('#TotalSoft_Poll_5_V_T').val();
    var TotalSoft_Poll_5_V_Eff = jQuery('#TotalSoft_Poll_5_V_Eff').val();
    var TotalSoft_Poll_5_BB_MBgC = jQuery('#TotalSoft_Poll_5_BB_MBgC').val();
    var TotalSoft_Poll_5_BB_Pos = jQuery('#TotalSoft_Poll_5_BB_Pos').val();
    var TotalSoft_Poll_5_BB_BC = jQuery('#TotalSoft_Poll_5_BB_BC').val();
    var TotalSoft_Poll_5_BB_BgC = jQuery('#TotalSoft_Poll_5_BB_BgC').val();
    var TotalSoft_Poll_5_BB_C = jQuery('#TotalSoft_Poll_5_BB_C').val();
    var TotalSoft_Poll_5_BB_IT = jQuery('#TotalSoft_Poll_5_BB_IT').val();
    var TotalSoft_Poll_5_BB_IA = jQuery('#TotalSoft_Poll_5_BB_IA').val();
    var TotalSoft_Poll_5_BB_HBgC = jQuery('#TotalSoft_Poll_5_BB_HBgC').val();
    var TotalSoft_Poll_5_BB_HC = jQuery('#TotalSoft_Poll_5_BB_HC').val();
    var TotalSoft_Poll_5_TV_Text = jQuery('#TotalSoft_Poll_5_TV_Text').val();
    var TotalSoft_Poll_5_BB_Text = jQuery('#TotalSoft_Poll_5_BB_Text').val();
    var TotalSoft_Poll_5_RB_Text = jQuery('#TotalSoft_Poll_5_RB_Text').val();
    var TotalSoft_Poll_5_VB_Text = jQuery('#TotalSoft_Poll_5_VB_Text').val();

    if (TotalSoft_Poll_5_TV_Show == 'checked') {
      TotalSoft_Poll_5_TV_Show = 'true';
    } else {
      TotalSoft_Poll_5_TV_Show = 'false';
    }
    if (TotalSoft_Poll_5_VB_Show == 'checked') {
      TotalSoft_Poll_5_VB_Show = 'true';
    } else {
      TotalSoft_Poll_5_VB_Show = 'false';
    }
    if (TotalSoft_Poll_5_RB_Show == 'checked') {
      TotalSoft_Poll_5_RB_Show = 'true';
    } else {
      TotalSoft_Poll_5_RB_Show = 'false';
    }
...
function TotalSoftPoll_Edit_Set(Set_ID) {
  ...
  jQuery.ajax({
    ...
    success: function (response) {
      ...
      // jQuery('#TotalSoft_Poll_Set_11').val("IP Address");
