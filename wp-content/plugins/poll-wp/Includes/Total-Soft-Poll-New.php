...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="Total_Soft_Poll_AMD">
        ...
        <div class="Total_Soft_Poll_AMD2">
            ...
            <span class="Total_Soft_Poll_AMD2_But"
                  onclick="Total_Soft_Poll_AMD2_But1(<?php echo $TotalSoftPollShortID[0]->Poll_ID + 1; ?>)">
				Create Poll
			</span>
        </div>
    ...
    <table class="Total_Soft_Poll_AMOTable">
         ...
         <tr id="Total_Soft_Poll_AMOTable_tr_<?php echo $TotalSoftPollCount[ $i ]->id; ?>">
             ...
             <td>
                 <a href="<?php echo home_url(); ?>?ts_poll_preview_poll=<?php echo $TotalSoftPollCount[ $i ]->id; ?>"
                    class="Total_Soft_Poll_AMD2_But_LP" target="_blank">
                     <i class="totalsoft totalsoft-eye"></i>
                 </a>
             </td>
             <td><i class="totalsoft totalsoft-file-text"
                    onclick="TotalSoftPoll_Clone(<?php echo $TotalSoftPollCount[ $i ]->id; ?>)"></i></td>
             <td><i class="totalsoft totalsoft-pencil"
                    onclick="TotalSoftPoll_Edit(<?php echo $TotalSoftPollCount[ $i ]->id; ?>)"></i></td>
             <td>
                 <i class="totalsoft totalsoft-trash"
                    onclick="TotalSoftPoll_Del(<?php echo $TotalSoftPollCount[ $i ]->id; ?>)"></i>
                 <span class="Total_Soft_Poll_Del_Span">
						<i class="Total_Soft_Poll_Del_Span_Yes totalsoft totalsoft-check"
                           onclick="TotalSoftPoll_Del_Yes(<?php echo $TotalSoftPollCount[ $i ]->id; ?>)"></i>
						<i class="Total_Soft_Poll_Del_Span_No totalsoft totalsoft-times"
                           onclick="TotalSoftPoll_Del_No(<?php echo $TotalSoftPollCount[ $i ]->id; ?>)"></i>
					</span>
             </td>
         </tr>
					<?php } ?>
            ...
            <tr>
                ...
                <td>
                    <select class="Total_Soft_Poll_Select" id="TotalSoftPoll_Theme" name="TotalSoftPoll_Theme"
                         ...
                         <option id="TotalSoftPoll_Theme_<?php echo $TotalSoftPollThemes[ $i ]->id; ?>"
                                 value="<?php echo $TotalSoftPollThemes[ $i ]->id; ?>"
                                 rel="<?php echo $TotalSoftPollThemes[ $i ]->TotalSoft_Poll_TType; ?>"><?php echo $TotalSoftPollThemes[ $i ]->TotalSoft_Poll_TTitle; ?></option>
																					<?php } ?>
                    </select>
                </td>
            </tr>
