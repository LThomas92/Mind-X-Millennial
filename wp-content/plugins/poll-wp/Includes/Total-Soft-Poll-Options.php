<?php
	...
	if($_SERVER["REQUEST_METHOD"]=="POST")
	{
		if(check_admin_referer( 'edit-menu_', 'TS_Poll_Nonce' ))
		{
			...
			$TotalSoft_Poll_1_A_CTF = sanitize_text_field($_POST['TotalSoft_Poll_1_A_CTF']);
			...
			$TotalSoft_Poll_1_CH_CM = sanitize_text_field($_POST['TotalSoft_Poll_1_CH_CM']); 
			...
			<div class="TS_Poll_Option_Div TS_Poll_Option_Divv" id="Total_Soft_Poll_AMSetTable_1_AO">
				<div class="TS_Poll_Option_Divv1">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<div class="switch">
								<input class="cmn-toggle cmn-toggle-yes-no" type="checkbox" id="TotalSoft_Poll_1_A_CTF" name="TotalSoft_Poll_1_A_CTF" <?php echo $TotalSoft_Poll_1_A_CTF;?>>
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_1_A_FS" id="TotalSoft_Poll_1_A_FS" min="8" max="48" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_A_FS;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_1_A_MBgC" id="TotalSoft_Poll_1_A_MBgC" class="Total_Soft_Poll_T_Color_1" value="<?php echo $TotalSoftPollTheme_1_1[0]->TotalSoft_Poll_1_A_MBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_1_A_BgC" id="TotalSoft_Poll_1_A_BgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_A_BgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_1_A_C" id="TotalSoft_Poll_1_A_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_A_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_1_BoxSh" id="TotalSoft_Poll_1_BoxSh">
								<?php
									...
									{
										if( $TotalSoftFontGCount[$i] == $TotalSoft_Poll_1_BoxSh) { ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' selected="select" style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }else{ ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }
									}
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangeper" name="TotalSoft_Poll_1_LAA_W" id="TotalSoft_Poll_1_LAA_W" min="0" max="100" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_LAA_W;?>">
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Height <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the height for separation line."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_1_LAA_H" id="TotalSoft_Poll_1_LAA_H" min="0" max="5" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_LAA_H;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_1_LAA_C" id="TotalSoft_Poll_1_LAA_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_LAA_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Style <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Identify the basic style of the line and you can change it at any time. Select 4 different types of line: solid, dotted, dashed, none."></i></div>
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_1_LAA_S" id="TotalSoft_Poll_1_LAA_S">
								<option value="none"   <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_LAA_S=='none'){echo 'selected';}?>>   None   </option>
								<option value="solid"  <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_LAA_S=='solid'){echo 'selected';}?>>  Solid  </option>
								<option value="dotted" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_LAA_S=='dotted'){echo 'selected';}?>> Dotted </option>
								<option value="dashed" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_LAA_S=='dashed'){echo 'selected';}?>> Dashed </option>
							</select>
						</div>
					</div>
				</div>
				<div class="TS_Poll_Option_Divv2">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<div class="switch">
								<input class="cmn-toggle cmn-toggle-yes-no" type="checkbox" id="TotalSoft_Poll_1_CH_CM" name="TotalSoft_Poll_1_CH_CM" <?php echo $TotalSoft_Poll_1_CH_CM;?>>
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_1_CH_S" id="TotalSoft_Poll_1_CH_S">
								<option value="small"    <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_S=='small'){echo 'selected';}?>>    Small    </option>
								<option value="medium 1" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_S=='medium 1'){echo 'selected';}?>> Medium 1 </option>
								<option value="medium 2" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_S=='medium 2'){echo 'selected';}?>> Medium 2 </option>
								<option value="big"      <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_S=='big'){echo 'selected';}?>>      Big      </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_1_CH_TBC" id="TotalSoft_Poll_1_CH_TBC" style="font-family: 'FontAwesome', Arial;">
								<option value="f10c" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TBC=='f10c'){ echo 'selected';}?>> <?php echo '&#xf10c' . '&nbsp; ' . 'Circle O';?>       </option>
								<option value="f111" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TBC=='f111'){ echo 'selected';}?>> <?php echo '&#xf111' . '&nbsp; ' . 'Circle';?>         </option>
								<option value="f096" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TBC=='f096'){ echo 'selected';}?>> <?php echo '&#xf096' . '&nbsp; ' . 'Square O';?>       </option>
								<option value="f0c8" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TBC=='f0c8'){ echo 'selected';}?>> <?php echo '&#xf0c8' . '&nbsp; ' . 'Square';?>         </option>
								<option value="f147" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TBC=='f147'){ echo 'selected';}?>> <?php echo '&#xf147' . '&nbsp; ' . 'Minus Square O';?> </option>
								<option value="f146" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TBC=='f146'){ echo 'selected';}?>> <?php echo '&#xf146' . '&nbsp; ' . 'Minus Square';?>   </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_1_CH_CBC" id="TotalSoft_Poll_1_CH_CBC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_CBC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_1_CH_TAC" id="TotalSoft_Poll_1_CH_TAC" style="font-family: 'FontAwesome', Arial;">
								<option value="f00c" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TAC=='f00c'){ echo 'selected';}?>> <?php echo '&#xf00c' . '&nbsp; ' . 'Check';?>          </option>
								<option value="f058" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TAC=='f058'){ echo 'selected';}?>> <?php echo '&#xf058' . '&nbsp; ' . 'Check Circle';?>   </option>
								<option value="f05d" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TAC=='f05d'){ echo 'selected';}?>> <?php echo '&#xf05d' . '&nbsp; ' . 'Check Circle O';?> </option>
								<option value="f14a" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TAC=='f14a'){ echo 'selected';}?>> <?php echo '&#xf14a' . '&nbsp; ' . 'Check Square';?>   </option>
								<option value="f046" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TAC=='f046'){ echo 'selected';}?>> <?php echo '&#xf046' . '&nbsp; ' . 'Check Square O';?> </option>
								<option value="f111" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TAC=='f111'){ echo 'selected';}?>> <?php echo '&#xf111' . '&nbsp; ' . 'Circle';?>         </option>
								<option value="f192" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TAC=='f192'){ echo 'selected';}?>> <?php echo '&#xf192' . '&nbsp; ' . 'Dot Circle O';?>   </option>
								<option value="f196" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TAC=='f196'){ echo 'selected';}?>> <?php echo '&#xf196' . '&nbsp; ' . 'Plus Square O';?>  </option>
								<option value="f0fe" <?php if($TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_TAC=='f0fe'){ echo 'selected';}?>> <?php echo '&#xf0fe' . '&nbsp; ' . 'Plus Square';?>    </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_1_CH_CAC" id="TotalSoft_Poll_1_CH_CAC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_CH_CAC;?>">
						</div>
					</div>
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_1_A_HBgC" id="TotalSoft_Poll_1_A_HBgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_A_HBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_1_A_HC" id="TotalSoft_Poll_1_A_HC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_1[0]->TotalSoft_Poll_1_A_HC;?>">
						</div>
					</div>
				</div>
			</div>
	...
	<div class="Total_Soft_Poll_AMSetDiv" id="Total_Soft_Poll_TMSetTable_2">
		...
		<div class="Total_Soft_Poll_AMSetDiv_Content">
			...
			<div class="TS_Poll_Option_Div TS_Poll_Option_Divv" id="Total_Soft_Poll_AMSetTable_2_AO">
				<div class="TS_Poll_Option_Divv1">
					<div class="TS_Poll_Option_Div1 Total_Soft_Poll_TMTitles">Answer Optio$n</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range" name="TotalSoft_Poll_2_A_CC" id="TotalSoft_Poll_2_A_CC" min="1" max="5" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_CC;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_A_IHT" id="TotalSoft_Poll_2_A_IHT">
								<option value="fixed" <?php if($TotalSoft_Poll_2_A_IHT == 'fixed'){echo 'selected';}?>> Fixed </option>
								<option value="ratio" <?php if($TotalSoft_Poll_2_A_IHT == 'ratio'){echo 'selected';}?>> Ratio </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_2_A_IH" id="TotalSoft_Poll_2_A_IH" min="50" max="800" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_IH;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_A_IHR" id="TotalSoft_Poll_2_A_IHR">
								<option value="1" <?php if($TotalSoft_Poll_2_A_IHR=='1'){echo 'selected';}?>> 1x1  </option>
								<option value="2" <?php if($TotalSoft_Poll_2_A_IHR=='2'){echo 'selected';}?>> 16x9 </option>
								<option value="3" <?php if($TotalSoft_Poll_2_A_IHR=='3'){echo 'selected';}?>> 9x16 </option>
								<option value="4" <?php if($TotalSoft_Poll_2_A_IHR=='4'){echo 'selected';}?>> 3x4  </option>
								<option value="5" <?php if($TotalSoft_Poll_2_A_IHR=='5'){echo 'selected';}?>> 4x3  </option>
								<option value="6" <?php if($TotalSoft_Poll_2_A_IHR=='6'){echo 'selected';}?>> 3x2  </option>
								<option value="7" <?php if($TotalSoft_Poll_2_A_IHR=='7'){echo 'selected';}?>> 2x3  </option>
								<option value="8" <?php if($TotalSoft_Poll_2_A_IHR=='8'){echo 'selected';}?>> 8x5  </option>
								<option value="9" <?php if($TotalSoft_Poll_2_A_IHR=='9'){echo 'selected';}?>> 5x8  </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_A_CA" id="TotalSoft_Poll_2_A_CA">
								<option value="Nothing"    <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_CA=='Nothing'){echo 'selected';}?>>    For Nothing    </option>
								<option value="Color"      <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_CA=='Color'){echo 'selected';}?>>      For Color      </option>
								<option value="Background" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_CA=='Background'){echo 'selected';}?>> For Background </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_2_A_FS" id="TotalSoft_Poll_2_A_FS" min="8" max="48" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_FS;?>">
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Main Background Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Here you can select your favourite main background color for theme."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_A_MBgC" id="TotalSoft_Poll_2_A_MBgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_MBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Background Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Use this option to change the color for background."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_A_BgC" id="TotalSoft_Poll_2_A_BgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_BgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Change the font color of element answers."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_A_C" id="TotalSoft_Poll_2_A_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_A_Pos" id="TotalSoft_Poll_2_A_Pos">
								<option value="Position 1" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_Pos=='Position 1'){echo 'selected';}?>> Before Image               </option>
								<option value="Position 2" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_Pos=='Position 2'){echo 'selected';}?>> Before Image Only Checkbox </option>
								<option value="Position 3" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_Pos=='Position 3'){echo 'selected';}?>> After Image                </option>
								<option value="Position 4" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_Pos=='Position 4'){echo 'selected';}?>> After Image Only Checkbox  </option>
								<option value="Position 5" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_Pos=='Position 5'){echo 'selected';}?>> Left  </option>
								<option value="Position 6" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_Pos=='Position 6'){echo 'selected';}?>> Right  </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_BoxSh" id="TotalSoft_Poll_2_BoxSh">
								<?php
									for($i = 0; $i < count($TotalSoftFontGCount); $i++)
									{
										if( $TotalSoftFontGCount[$i] == $TotalSoft_Poll_2_BoxSh) { ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' selected="select" style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }else{ ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangeper" name="TotalSoft_Poll_2_LAA_W" id="TotalSoft_Poll_2_LAA_W" min="0" max="100" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_LAA_W;?>">
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Height <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the height for separation line."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_2_LAA_H" id="TotalSoft_Poll_2_LAA_H" min="0" max="5" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_LAA_H;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_LAA_C" id="TotalSoft_Poll_2_LAA_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_LAA_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Style <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Identify the basic style of the line and you can change it at any time. Select 4 different types of line: solid, dotted, dashed, none."></i></div>
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_LAA_S" id="TotalSoft_Poll_2_LAA_S">
								<option value="none"   <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_LAA_S=='none'){echo 'selected';}?>>   None   </option>
								<option value="solid"  <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_LAA_S=='solid'){echo 'selected';}?>>  Solid  </option>
								<option value="dotted" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_LAA_S=='dotted'){echo 'selected';}?>> Dotted </option>
								<option value="dashed" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_LAA_S=='dashed'){echo 'selected';}?>> Dashed </option>
							</select>
						</div>
					</div>
				</div>
				<div class="TS_Poll_Option_Divv2">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<div class="switch">
								<input class="cmn-toggle cmn-toggle-yes-no" type="checkbox" id="TotalSoft_Poll_2_CH_CM" name="TotalSoft_Poll_2_CH_CM" <?php echo $TotalSoft_Poll_2_CH_CM;?>>
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_CH_S" id="TotalSoft_Poll_2_CH_S">
								<option value="small"    <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_S=='small'){echo 'selected';}?>>    Small    </option>
								<option value="medium 1" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_S=='medium 1'){echo 'selected';}?>> Medium 1 </option>
								<option value="medium 2" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_S=='medium 2'){echo 'selected';}?>> Medium 2 </option>
								<option value="big"      <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_S=='big'){echo 'selected';}?>>      Big      </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_CH_TBC" id="TotalSoft_Poll_2_CH_TBC" style="font-family: 'FontAwesome', Arial;">
								<option value="f10c" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TBC=='f10c'){ echo 'selected';}?>> <?php echo '&#xf10c' . '&nbsp; ' . 'Circle O';?>       </option>
								<option value="f111" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TBC=='f111'){ echo 'selected';}?>> <?php echo '&#xf111' . '&nbsp; ' . 'Circle';?>         </option>
								<option value="f096" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TBC=='f096'){ echo 'selected';}?>> <?php echo '&#xf096' . '&nbsp; ' . 'Square O';?>       </option>
								<option value="f0c8" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TBC=='f0c8'){ echo 'selected';}?>> <?php echo '&#xf0c8' . '&nbsp; ' . 'Square';?>         </option>
								<option value="f147" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TBC=='f147'){ echo 'selected';}?>> <?php echo '&#xf147' . '&nbsp; ' . 'Minus Square O';?> </option>
								<option value="f146" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TBC=='f146'){ echo 'selected';}?>> <?php echo '&#xf146' . '&nbsp; ' . 'Minus Square';?>   </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_CH_CBC" id="TotalSoft_Poll_2_CH_CBC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_CBC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_CH_TAC" id="TotalSoft_Poll_2_CH_TAC" style="font-family: 'FontAwesome', Arial;">
								<option value="f00c" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TAC=='f00c'){ echo 'selected';}?>> <?php echo '&#xf00c' . '&nbsp; ' . 'Check';?>          </option>
								<option value="f058" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TAC=='f058'){ echo 'selected';}?>> <?php echo '&#xf058' . '&nbsp; ' . 'Check Circle';?>   </option>
								<option value="f05d" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TAC=='f05d'){ echo 'selected';}?>> <?php echo '&#xf05d' . '&nbsp; ' . 'Check Circle O';?> </option>
								<option value="f14a" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TAC=='f14a'){ echo 'selected';}?>> <?php echo '&#xf14a' . '&nbsp; ' . 'Check Square';?>   </option>
								<option value="f046" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TAC=='f046'){ echo 'selected';}?>> <?php echo '&#xf046' . '&nbsp; ' . 'Check Square O';?> </option>
								<option value="f111" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TAC=='f111'){ echo 'selected';}?>> <?php echo '&#xf111' . '&nbsp; ' . 'Circle';?>         </option>
								<option value="f192" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TAC=='f192'){ echo 'selected';}?>> <?php echo '&#xf192' . '&nbsp; ' . 'Dot Circle O';?>   </option>
								<option value="f196" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TAC=='f196'){ echo 'selected';}?>> <?php echo '&#xf196' . '&nbsp; ' . 'Plus Square O';?>  </option>
								<option value="f0fe" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_TAC=='f0fe'){ echo 'selected';}?>> <?php echo '&#xf0fe' . '&nbsp; ' . 'Plus Square';?>    </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_CH_CAC" id="TotalSoft_Poll_2_CH_CAC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_CH_CAC;?>">
						</div>
					</div>
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Background Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Use this option to change the hover color for background."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_A_HBgC" id="TotalSoft_Poll_2_A_HBgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_HBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Change the font hover color of element answers."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_A_HC" id="TotalSoft_Poll_2_A_HC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_HC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<div class="switch">
								<input class="cmn-toggle cmn-toggle-yes-no" type="checkbox" id="TotalSoft_Poll_2_A_HSh_Show" name="TotalSoft_Poll_2_A_HSh_Show" <?php echo $TotalSoft_Poll_2_A_HSh_Show;?>>
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_A_HShC" id="TotalSoft_Poll_2_A_HShC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_A_HShC;?>">
						</div>
					</div>
					...
					<div class="TS_Poll_Option_Div1 Total_Soft_Poll_Video_Set">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_Play_IC" id="TotalSoft_Poll_2_Play_IC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1 Total_Soft_Poll_Video_Set">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_2_Play_IS" id="TotalSoft_Poll_2_Play_IS" min="8" max="150" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IS;?>">
					...
					<div class="TS_Poll_Option_Div1 Total_Soft_Poll_Video_Set">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_2_Play_IOvC" id="TotalSoft_Poll_2_Play_IOvC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IOvC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1 Total_Soft_Poll_Video_Set">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_2_Play_IT" id="TotalSoft_Poll_2_Play_IT" style="font-family: 'FontAwesome', Arial;">
								<option value=""     <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IT==''){ echo 'selected';}?>>     None                                                        </option>
								<option value="f04b" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IT=='f04b'){ echo 'selected';}?>> <?php echo '&#xf04b' . '&nbsp; &nbsp;' . 'Play';?>          </option>
								<option value="f16a" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IT=='f16a'){ echo 'selected';}?>> <?php echo '&#xf16a' . '&nbsp; ' . 'YouTube Play';?>        </option>
								<option value="f144" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IT=='f144'){ echo 'selected';}?>> <?php echo '&#xf144' . '&nbsp; &nbsp;' . 'Play Circle';?>   </option>
								<option value="f01d" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IT=='f01d'){ echo 'selected';}?>> <?php echo '&#xf01d' . '&nbsp; &nbsp;' . 'Play Circle O';?> </option>
								<option value="f03d" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IT=='f03d'){ echo 'selected';}?>> <?php echo '&#xf03d' . '&nbsp; ' . 'Video Camera';?>        </option>
								<option value="f26c" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IT=='f26c'){ echo 'selected';}?>> <?php echo '&#xf26c' . '&nbsp; ' . 'Television';?>          </option>
								<option value="f008" <?php if($TotalSoftPollTheme_2[0]->TotalSoft_Poll_2_Play_IT=='f008'){ echo 'selected';}?>> <?php echo '&#xf008' . '&nbsp; &nbsp;' . 'Film';?>          </option>
							</select>
						</div>
					</div>
				</div>
			...
			<div class="TS_Poll_Option_Div TS_Poll_Option_Divv" id="Total_Soft_Poll_AMSetTable_3_AO">
				<div class="TS_Poll_Option_Divv1">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_3_A_CA" id="TotalSoft_Poll_3_A_CA">
								<option value="Nothing"    <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_CA=='Nothing'){echo 'selected';}?>>    For Nothing    </option>
								<option value="Color"      <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_CA=='Color'){echo 'selected';}?>>      For Color      </option>
								<option value="Background" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_CA=='Background'){echo 'selected';}?>> For Background </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Font Size <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="This option is for the answers. You can select font size."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_3_A_FS" id="TotalSoft_Poll_3_A_FS" min="8" max="48" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_FS;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_3_A_MBgC" id="TotalSoft_Poll_3_A_MBgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_MBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_3_A_BgC" id="TotalSoft_Poll_3_A_BgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_BgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_3_A_C" id="TotalSoft_Poll_3_A_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_3_A_BW" id="TotalSoft_Poll_3_A_BW" min="0" max="8" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_BW;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_3_A_BC" id="TotalSoft_Poll_3_A_BC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_BC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_3_A_BR" id="TotalSoft_Poll_3_A_BR" min="0" max="10" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_BR;?>">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_3_BoxSh" id="TotalSoft_Poll_3_BoxSh">
								<?php
									for($i = 0; $i < count($TotalSoftFontGCount); $i++)
									{
										if( $TotalSoftFontGCount[$i] == $TotalSoft_Poll_3_BoxSh) { ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' selected="select" style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }else{ ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_3_A_HBgC" id="TotalSoft_Poll_3_A_HBgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_HBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Change the font hover color of element answers."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_3_A_HC" id="TotalSoft_Poll_3_A_HC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_A_HC;?>">
						</div>
					</div>
				</div>
				<div class="TS_Poll_Option_Divv2">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<div class="switch">
								<input class="cmn-toggle cmn-toggle-yes-no" type="checkbox" id="TotalSoft_Poll_3_CH_Sh" name="TotalSoft_Poll_3_CH_Sh" <?php echo $TotalSoft_Poll_3_CH_Sh;?>>
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_3_CH_S" id="TotalSoft_Poll_3_CH_S">
								<option value="small"    <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_S=='small'){echo 'selected';}?>>    Small    </option>
								<option value="medium 1" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_S=='medium 1'){echo 'selected';}?>> Medium 1 </option>
								<option value="medium 2" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_S=='medium 2'){echo 'selected';}?>> Medium 2 </option>
								<option value="big"      <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_S=='big'){echo 'selected';}?>>      Big      </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_3_CH_TBC" id="TotalSoft_Poll_3_CH_TBC" style="font-family: 'FontAwesome', Arial;">
								<option value="f10c" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TBC=='f10c'){ echo 'selected';}?>> <?php echo '&#xf10c' . '&nbsp; ' . 'Circle O';?>       </option>
								<option value="f111" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TBC=='f111'){ echo 'selected';}?>> <?php echo '&#xf111' . '&nbsp; ' . 'Circle';?>         </option>
								<option value="f096" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TBC=='f096'){ echo 'selected';}?>> <?php echo '&#xf096' . '&nbsp; ' . 'Square O';?>       </option>
								<option value="f0c8" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TBC=='f0c8'){ echo 'selected';}?>> <?php echo '&#xf0c8' . '&nbsp; ' . 'Square';?>         </option>
								<option value="f147" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TBC=='f147'){ echo 'selected';}?>> <?php echo '&#xf147' . '&nbsp; ' . 'Minus Square O';?> </option>
								<option value="f146" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TBC=='f146'){ echo 'selected';}?>> <?php echo '&#xf146' . '&nbsp; ' . 'Minus Square';?>   </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Color Before Checking <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select color for selected checkbox."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_3_CH_CBC" id="TotalSoft_Poll_3_CH_CBC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_CBC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Type After Clicking <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="This field be used for selecting the values from a list of checkboxes"></i></div>
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_3_CH_TAC" id="TotalSoft_Poll_3_CH_TAC" style="font-family: 'FontAwesome', Arial;">
								<option value="f00c" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TAC=='f00c'){ echo 'selected';}?>> <?php echo '&#xf00c' . '&nbsp; ' . 'Check';?>          </option>
								<option value="f058" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TAC=='f058'){ echo 'selected';}?>> <?php echo '&#xf058' . '&nbsp; ' . 'Check Circle';?>   </option>
								<option value="f05d" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TAC=='f05d'){ echo 'selected';}?>> <?php echo '&#xf05d' . '&nbsp; ' . 'Check Circle O';?> </option>
								<option value="f14a" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TAC=='f14a'){ echo 'selected';}?>> <?php echo '&#xf14a' . '&nbsp; ' . 'Check Square';?>   </option>
								<option value="f046" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TAC=='f046'){ echo 'selected';}?>> <?php echo '&#xf046' . '&nbsp; ' . 'Check Square O';?> </option>
								<option value="f111" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TAC=='f111'){ echo 'selected';}?>> <?php echo '&#xf111' . '&nbsp; ' . 'Circle';?>         </option>
								<option value="f192" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TAC=='f192'){ echo 'selected';}?>> <?php echo '&#xf192' . '&nbsp; ' . 'Dot Circle O';?>   </option>
								<option value="f196" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TAC=='f196'){ echo 'selected';}?>> <?php echo '&#xf196' . '&nbsp; ' . 'Plus Square O';?>  </option>
								<option value="f0fe" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_TAC=='f0fe'){ echo 'selected';}?>> <?php echo '&#xf0fe' . '&nbsp; ' . 'Plus Square';?>    </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Color After Clicking <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select color for selected checkbox."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_3_CH_CAC" id="TotalSoft_Poll_3_CH_CAC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_CH_CAC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1 Total_Soft_Poll_TMTitles Total_Soft_Poll_TMTitles1">Line After Answers</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangeper" name="TotalSoft_Poll_3_LAA_W" id="TotalSoft_Poll_3_LAA_W" min="0" max="100" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_LAA_W;?>">
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Height <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the height for separation line."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_3_LAA_H" id="TotalSoft_Poll_3_LAA_H" min="0" max="5" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_LAA_H;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_3_LAA_C" id="TotalSoft_Poll_3_LAA_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_LAA_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Style <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Identify the basic style of the line and you can change it at any time. Select 4 different types of line: solid, dotted, dashed, none."></i></div>
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_3_LAA_S" id="TotalSoft_Poll_3_LAA_S">
								<option value="none"   <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_LAA_S=='none'){echo 'selected';}?>>   None   </option>
								<option value="solid"  <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_LAA_S=='solid'){echo 'selected';}?>>  Solid  </option>
								<option value="dotted" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_LAA_S=='dotted'){echo 'selected';}?>> Dotted </option>
								<option value="dashed" <?php if($TotalSoftPollTheme_3[0]->TotalSoft_Poll_3_LAA_S=='dashed'){echo 'selected';}?>> Dashed </option>
							</select>
						</div>
					</div>
				</div>
			...
			<div class="TS_Poll_Option_Div TS_Poll_Option_Divv" id="Total_Soft_Poll_AMSetTable_4_AO">
				<div class="TS_Poll_Option_Divv1">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_4_A_CA" id="TotalSoft_Poll_4_A_CA">
								<option value="Nothing"    <?php if($TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_CA=='Nothing'){echo 'selected';}?>>    For Nothing    </option>
								<option value="Color"      <?php if($TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_CA=='Color'){echo 'selected';}?>>      For Color      </option>
								<option value="Background" <?php if($TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_CA=='Background'){echo 'selected';}?>> For Background </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Font Size <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="This option is for the answers. You can select font size."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_4_A_FS" id="TotalSoft_Poll_4_A_FS" min="8" max="48" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_FS;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_4_A_MBgC" id="TotalSoft_Poll_4_A_MBgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_MBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_4_A_BgC" id="TotalSoft_Poll_4_A_BgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_BgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_4_A_C" id="TotalSoft_Poll_4_A_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_4_A_BW" id="TotalSoft_Poll_4_A_BW" min="0" max="8" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_BW;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_4_A_BC" id="TotalSoft_Poll_4_A_BC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_BC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_4_A_BR" id="TotalSoft_Poll_4_A_BR" min="0" max="10" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_BR;?>">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_4_A_FF" id="TotalSoft_Poll_4_A_FF">
								<?php
									for($i = 0; $i < count($TotalSoftFontGCount); $i++)
									{
										if( $TotalSoftFontGCount[$i] == $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_FF) { ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' selected="select" style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }else{ ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }
				...
				<div class="TS_Poll_Option_Divv2">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_4_A_HBgC" id="TotalSoft_Poll_4_A_HBgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_HBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_4_A_HC" id="TotalSoft_Poll_4_A_HC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_A_HC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1 Total_Soft_Poll_TMTitles Total_Soft_Poll_TMTitles1">Line After Answers</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangeper" name="TotalSoft_Poll_4_LAA_W" id="TotalSoft_Poll_4_LAA_W" min="0" max="100" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_LAA_W;?>">
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Height <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the height for separation line."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_4_LAA_H" id="TotalSoft_Poll_4_LAA_H" min="0" max="5" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_LAA_H;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_4_LAA_C" id="TotalSoft_Poll_4_LAA_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_LAA_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_4_LAA_S" id="TotalSoft_Poll_4_LAA_S">
								<option value="none"   <?php if($TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_LAA_S=='none'){echo 'selected';}?>>   None   </option>
								<option value="solid"  <?php if($TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_LAA_S=='solid'){echo 'selected';}?>>  Solid  </option>
								<option value="dotted" <?php if($TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_LAA_S=='dotted'){echo 'selected';}?>> Dotted </option>
								<option value="dashed" <?php if($TotalSoftPollTheme_4[0]->TotalSoft_Poll_4_LAA_S=='dashed'){echo 'selected';}?>> Dashed </option>
							</select>
						</div>
					</div>
				</div>
			...
			<div class="TS_Poll_Option_Div TS_Poll_Option_Divv" id="Total_Soft_Poll_AMSetTable_5_AO">
				<div class="TS_Poll_Option_Divv1">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_5_A_CA" id="TotalSoft_Poll_5_A_CA">
								<option value="Nothing"    <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_CA=='Nothing'){echo 'selected';}?>>    For Nothing    </option>
								<option value="Color"      <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_CA=='Color'){echo 'selected';}?>>      For Color      </option>
								<option value="Background" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_CA=='Background'){echo 'selected';}?>> For Background </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Font Size <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="This option is for the answers. You can select font size."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_5_A_FS" id="TotalSoft_Poll_5_A_FS" min="8" max="48" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_FS;?>">
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Main Background Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the main background color of the element where answers is placed."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_5_A_MBgC" id="TotalSoft_Poll_5_A_MBgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_MBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Background Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Use this option to change the background color."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_5_A_BgC" id="TotalSoft_Poll_5_A_BgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_BgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the font color of element answers."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_5_A_C" id="TotalSoft_Poll_5_A_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_5_A_BW" id="TotalSoft_Poll_5_A_BW" min="0" max="8" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_BW;?>">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_5_A_BC" id="TotalSoft_Poll_5_A_BC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_BC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Border Radius <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Set radius of the borders around answers container."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_5_A_BR" id="TotalSoft_Poll_5_A_BR" min="0" max="10" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_BR;?>">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_5_BoxSh" id="TotalSoft_Poll_5_BoxSh">
								<?php
									for($i = 0; $i < count($TotalSoftFontGCount); $i++)
									{
										if( $TotalSoftFontGCount[$i] == $TotalSoft_Poll_5_BoxSh) { ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' selected="select" style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }else{ ?>
											<option value='<?php echo $TotalSoftFontGCount[$i];?>' style="font-family: <?php echo $TotalSoftFontGCount[$i];?>;"><?php echo $TotalSoftFontCount[$i];?></option>
										<?php }
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Background Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Use this option to change the hover background color."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_5_A_HBgC" id="TotalSoft_Poll_5_A_HBgC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_HBgC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_5_A_HC" id="TotalSoft_Poll_5_A_HC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_A_HC;?>">
						</div>
					</div>
				</div>
				<div class="TS_Poll_Option_Divv2">
					...
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_5_CH_S" id="TotalSoft_Poll_5_CH_S">
								<option value="small"    <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_S=='small'){echo 'selected';}?>>    Small    </option>
								<option value="medium 1" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_S=='medium 1'){echo 'selected';}?>> Medium 1 </option>
								<option value="medium 2" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_S=='medium 2'){echo 'selected';}?>> Medium 2 </option>
								<option value="big"      <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_S=='big'){echo 'selected';}?>>      Big      </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_5_CH_TBC" id="TotalSoft_Poll_5_CH_TBC" style="font-family: 'FontAwesome', Arial;">
								<option value="f10c" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TBC=='f10c'){ echo 'selected';}?>> <?php echo '&#xf10c' . '&nbsp; ' . 'Circle O';?>       </option>
								<option value="f111" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TBC=='f111'){ echo 'selected';}?>> <?php echo '&#xf111' . '&nbsp; ' . 'Circle';?>         </option>
								<option value="f096" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TBC=='f096'){ echo 'selected';}?>> <?php echo '&#xf096' . '&nbsp; ' . 'Square O';?>       </option>
								<option value="f0c8" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TBC=='f0c8'){ echo 'selected';}?>> <?php echo '&#xf0c8' . '&nbsp; ' . 'Square';?>         </option>
								<option value="f147" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TBC=='f147'){ echo 'selected';}?>> <?php echo '&#xf147' . '&nbsp; ' . 'Minus Square O';?> </option>
								<option value="f146" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TBC=='f146'){ echo 'selected';}?>> <?php echo '&#xf146' . '&nbsp; ' . 'Minus Square';?>   </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Color Before Checking <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select color for checkbox before checking."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_5_CH_CBC" id="TotalSoft_Poll_5_CH_CBC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_CBC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Type After Clicking <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="This field be used for selecting the values from a list of checkboxes."></i></div>
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_5_CH_TAC" id="TotalSoft_Poll_5_CH_TAC" style="font-family: 'FontAwesome', Arial;">
								<option value="f00c" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TAC=='f00c'){ echo 'selected';}?>> <?php echo '&#xf00c' . '&nbsp; ' . 'Check';?>          </option>
								<option value="f058" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TAC=='f058'){ echo 'selected';}?>> <?php echo '&#xf058' . '&nbsp; ' . 'Check Circle';?>   </option>
								<option value="f05d" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TAC=='f05d'){ echo 'selected';}?>> <?php echo '&#xf05d' . '&nbsp; ' . 'Check Circle O';?> </option>
								<option value="f14a" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TAC=='f14a'){ echo 'selected';}?>> <?php echo '&#xf14a' . '&nbsp; ' . 'Check Square';?>   </option>
								<option value="f046" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TAC=='f046'){ echo 'selected';}?>> <?php echo '&#xf046' . '&nbsp; ' . 'Check Square O';?> </option>
								<option value="f111" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TAC=='f111'){ echo 'selected';}?>> <?php echo '&#xf111' . '&nbsp; ' . 'Circle';?>         </option>
								<option value="f192" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TAC=='f192'){ echo 'selected';}?>> <?php echo '&#xf192' . '&nbsp; ' . 'Dot Circle O';?>   </option>
								<option value="f196" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TAC=='f196'){ echo 'selected';}?>> <?php echo '&#xf196' . '&nbsp; ' . 'Plus Square O';?>  </option>
								<option value="f0fe" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_TAC=='f0fe'){ echo 'selected';}?>> <?php echo '&#xf0fe' . '&nbsp; ' . 'Plus Square';?>    </option>
							</select>
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Color After Clicking <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select color for checkbox after checking."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_5_CH_CAC" id="TotalSoft_Poll_5_CH_CAC" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_CH_CAC;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1 Total_Soft_Poll_TMTitles Total_Soft_Poll_TMTitles1">Line After Answers</div>
					<div class="TS_Poll_Option_Div1">
						...
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangeper" name="TotalSoft_Poll_5_LAA_W" id="TotalSoft_Poll_5_LAA_W" min="0" max="100" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_LAA_W;?>">
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Height <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Choose the height for separation line."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="range" class="TotalSoft_Poll_Range TotalSoft_Poll_Rangepx" name="TotalSoft_Poll_5_LAA_H" id="TotalSoft_Poll_5_LAA_H" min="0" max="5" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_LAA_H;?>">
					...
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Color <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Select your preferred color to show the line of separation after answers."></i></div>
						<div class="TS_Poll_Option_Field">
							<input type="text" name="TotalSoft_Poll_5_LAA_C" id="TotalSoft_Poll_5_LAA_C" class="Total_Soft_Poll_T_Color" value="<?php echo $TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_LAA_C;?>">
						</div>
					</div>
					<div class="TS_Poll_Option_Div1">
						<div class="TS_Poll_Option_Name">Style <i class="Total_Soft_Poll_Help1 totalsoft totalsoft-question-circle-o" title="Identify the basic style of the line and you can change it at any time. Select 4 different types of line: solid, dotted, dashed, none."></i></div>
						<div class="TS_Poll_Option_Field">
							<select class="Total_Soft_Poll_Select" name="TotalSoft_Poll_5_LAA_S" id="TotalSoft_Poll_5_LAA_S">
								<option value="none"   <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_LAA_S=='none'){echo 'selected';}?>>   None   </option>
								<option value="solid"  <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_LAA_S=='solid'){echo 'selected';}?>>  Solid  </option>
								<option value="dotted" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_LAA_S=='dotted'){echo 'selected';}?>> Dotted </option>
								<option value="dashed" <?php if($TotalSoftPollTheme_5[0]->TotalSoft_Poll_5_LAA_S=='dashed'){echo 'selected';}?>> Dashed </option>
							</select>
						</div>
					</div>
				</div>
