...
class Total_Soft_Poll extends WP_Widget {
   ...
   <div>
     <p>
       Select Question: <select name="<?php echo $this->get_field_name('Total_Soft_Poll'); ?>" class="widefat">
							<?php
							global $wpdb;
							...
							foreach($Total_Soft_Poll as $Total_Soft_Poll1){
								?>
         <option value="<?php echo $Total_Soft_Poll1->id; ?>" <?php if($instance['Total_Soft_Poll']==$Total_Soft_Poll1->id){
										print "selected";
									} ?> > <?php echo $Total_Soft_Poll1->TotalSoftPoll_Question; ?> </option> <?php
							}
							?>
       </select>
     </p>
	...
	function widget($args,$instance) {
     ...
     <style type="text/css">
         ...
         <?php }?> border: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BW;?>px solid<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BC;?>;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Show == 'false' || $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'none'){ ?> -webkit-box-shadow: none;
             -moz-box-shadow: none;
             box-shadow: none;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'true'){ ?> -webkit-box-shadow: 0px 0px 13px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'false'){ ?> -webkit-box-shadow: 0 25px 13px -18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'sh03'){ ?> box-shadow: 0 10px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'sh04'){ ?> box-shadow: 0 1px 4px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>, 0 0 40px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?> inset;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'sh05'){ ?> box-shadow: 0 0 10px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'sh06'){ ?> box-shadow: 4px -4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'sh07'){ ?> box-shadow: 5px 5px 3px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'sh08'){ ?> box-shadow: 2px 2px white, 4px 4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'sh09'){ ?> box-shadow: 8px 8px 18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'sh10'){ ?> box-shadow: 0 8px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh_Type == 'sh11'){ ?> box-shadow: 0 0 18px 7px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxShC;?>;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_A_CTF == 'true'){ ?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_A_C;?> !important;
         <?php }?> font-size: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_A_FS;?>px !important;
             cursor: pointer;
         ...
         <?php } else { ?> font-family: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh;?> !important;
         ...
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_RB_C;?> !important;
         ...
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_RB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_RB_C;?> !important;
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_VB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_VB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_VB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_VB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_VB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_VB_C;?> !important;
         }
         ...
         <?php } else { ?> font-family: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BoxSh;?>;
         <?php }?>
         }
         ...
         .Total_Soft_Poll_1_Main_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Lab_Sp2_<?php echo $Total_Soft_Poll;?>, .Total_Soft_Poll_1_Main_Ans_Div_Fix_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Lab_Sp2_<?php echo $Total_Soft_Poll;?> {
             ...
             min-width: 10px;
             height: 100%;
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_A_CTF == 'true'){ ?> background-color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_A_C;?> !important;
         <?php }?> left: 0;
             top: 0%;
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_BB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_BB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_VB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_BB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_BB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_BB_C;?> !important;
         }
     ...
     <form method="POST" onsubmit="">
       <div class="Total_Soft_Poll_Main_Div">
         <div class="Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll; ?>">
           ...
           <div class="Total_Soft_Poll_1_Quest_Main_Div_<?php echo $Total_Soft_Poll; ?>">
             <div class="Total_Soft_Poll_1_Quest_Div_<?php echo $Total_Soft_Poll; ?>">
               <span><?php echo html_entity_decode($Total_Soft_Poll_Man[0]->TotalSoftPoll_Question); ?></span>
               <div class="Total_Soft_Poll_1_LAQ_Div_<?php echo $Total_Soft_Poll; ?>"
             ...
             <div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll; ?>">
                ...
                <div class="Total_Soft_Poll_1_Ans_Check_Div">
                  <input type="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_CH_CM=='true'){
                   ...
                   id="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                   name="<?php echo $Total_Soft_Poll_1_Check_Name; ?>"
                   value="<?php echo $Total_Soft_Poll_Ans[$i]->id; ?>"> <label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?> totalsoft totalsoft-question-circle-o"
                   for="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                   style="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_A_CTF=='false'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>"><?php echo html_entity_decode($Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans); ?></label>
                </div>
														<?php } ?>
             ...
             <div class="Total_Soft_Poll_1_But_MDiv_<?php echo $Total_Soft_Poll; ?>">
                ...
                <button class="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
                 id="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
                 name="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>" type="button"
                 value="<?php echo html_entity_decode($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_RB_Text); ?>"
                 onclick="Total_Soft_Poll_1_Result(<?php echo $Total_Soft_Poll; ?>)">
                  <i class="totalsoft Total_Soft_Poll_1_Result_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_RB_Text); ?></span> </i>
                </button>
														<?php } ?>
														<?php
														$cookie=(isset($_COOKIE["TotalSoft_Poll_Cookie_" . $Total_Soft_Poll])) ? $_COOKIE["TotalSoft_Poll_Cookie_" . $Total_Soft_Poll]:'';
														if($cookie==''){ ?>
                <button class="Total_Soft_Poll_1_But_Vote Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>"
                 id="Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>"
                 name="Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>" type="button"
                 value="<?php echo html_entity_decode($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_VB_Text); ?>"
                 onclick="Total_Soft_Poll_1_But_Vote(<?php echo $Total_Soft_Poll; ?>,event)">
                  <i class="totalsoft Total_Soft_Poll_1_Vote_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_VB_Text); ?></span> </i>
                </button>
														<?php } ?>
           ...
           <div class="Total_Soft_Poll_1_Main_Ans_Div_<?php echo $Total_Soft_Poll; ?>">
             ...
             <div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll; ?>">
                ...
                <div class="Total_Soft_Poll_1_Ans_Check_Div">
                  <label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?>">
												<span style="margin-left: 3px; position: inherit; z-index: 99999999999; font-size: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_A_FS; ?>px">
													<?php echo html_entity_decode($Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans); ?>
												</span> <span class="Total_Soft_Poll_1_Ans_Lab_Sp2_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_1_Ans_Lab_Sp2_<?php echo $Total_Soft_Poll; ?>_<?php echo $i; ?>"
                     style="width: <?php echo round($Total_Soft_Poll_Res[$i]->Poll_A_Votes * 100 / $Total_Soft_Poll_Res_Count,2) . '%'; ?>;<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_A_CTF=='false'){ ?> background-color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>">
												</span> <span class="Total_Soft_Poll_1_Ans_Lab_Sp3_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_1_Ans_Lab_Sp3_<?php echo $Total_Soft_Poll; ?>_<?php echo $i; ?>">
             ...
             <div class="Total_Soft_Poll_1_But_MDiv_<?php echo $Total_Soft_Poll; ?>">
               <button class="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
                id="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
                name="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>" type="button"
                value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_BB_Text); ?>"
                onclick="Total_Soft_Poll_1_Back(<?php echo $Total_Soft_Poll; ?>)">
                 <i class="totalsoft Total_Soft_Poll_1_Back_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_BB_Text); ?></span> </i>
               </button>
             </div>
           </div>
         ...
         <input type="text" style="display: none;"
          id="TotalSoft_Poll_1_P_ShPop_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_ShPop; ?>"> <input type="text" style="display: none;"
          id="TotalSoft_Poll_1_P_ShEff_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_ShEff; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_1_MW_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_MW; ?>">
         ...
         <input type="text" style="display: none;" id="TotalSoft_Poll_<?php echo $Total_Soft_Poll; ?>_ID"
          ...
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>">

         <input type="text" style="display: none;" id="TotalSoft_Poll_1_BR_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BR; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_1_P_BW_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_BW; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_1_Pos_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_Pos; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_02_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_02; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_03_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_03; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_04_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo html_entity_decode($Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_04); ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_05_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo html_entity_decode($Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_05); ?>">
       </div>
     </form>
     <div class="Total_Soft_Poll_1_Ans_Fix_<?php echo $Total_Soft_Poll; ?>"
      onclick="Total_Soft_Poll_1_Ans_Fix_Close(this,'Total_Soft_Poll_1_Ans_Fix_1_<?php echo $Total_Soft_Poll; ?>')"
      style="cursor:pointer;"></div>
     <div class="Total_Soft_Poll_1_Ans_Fix_1_<?php echo $Total_Soft_Poll; ?>" style="cursor:pointer;"
      onclick="Total_Soft_Poll_1_Ans_Fix_Close2(this,'Total_Soft_Poll_1_Ans_Fix_<?php echo $Total_Soft_Poll; ?>')">
     ...
     <style type="text/css">
         ...
         <?php } else { ?> margin: 0 auto;
         <?php }?> border: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BW;?>px solid<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BC;?>;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Show == 'false' || $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'none'){ ?> -webkit-box-shadow: none;
             -moz-box-shadow: none;
             box-shadow: none;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'true'){ ?> -webkit-box-shadow: 0px 0px 13px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'false'){ ?> -webkit-box-shadow: 0 25px 13px -18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'sh03'){ ?> box-shadow: 0 10px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'sh04'){ ?> box-shadow: 0 1px 4px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>, 0 0 40px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?> inset;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'sh05'){ ?> box-shadow: 0 0 10px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'sh06'){ ?> box-shadow: 4px -4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'sh07'){ ?> box-shadow: 5px 5px 3px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'sh08'){ ?> box-shadow: 2px 2px white, 4px 4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'sh09'){ ?> box-shadow: 8px 8px 18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'sh10'){ ?> box-shadow: 0 8px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh_Type == 'sh11'){ ?> box-shadow: 0 0 18px 7px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxShC;?>;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_CA != 'Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_BgC;?>;
         ...
         <?php } else { ?> font-family: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_BoxSh;?>;
         <?php }?>
         }
         ...
         <?php }else{ ?> padding-bottom: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH;?>px;
         <?php }?>
         }
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_HSh_Show == 'true'){ ?> box-shadow: 0px 0px 5px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_HShC;?> !important;
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label {
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_CA != 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_C;?> !important;
         <?php }?> font-size: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_FS;?>px !important;
             cursor: pointer;
             margin-bottom: 0px !important;
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_RB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_RB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_2_Vote_But_Icon {
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_RB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_RB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_RB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_RB_C;?> !important;
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_VB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_VB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_VB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_VB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_VB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_VB_C;?> !important;
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_P_BB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_P_BB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_P_BB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_P_BB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_P_BB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_P_BB_C;?> !important;
         }
         ...
         <div class="Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll; ?>">
           ...
           <div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll; ?>">
              ...
              <div class="Total_Soft_Poll_1_Ans_Check_Div" <?php if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType=='Video Poll'){ ?> onmouseover="Total_Soft_Poll_Video_Hove(<?php echo $Total_Soft_Poll; ?>, <?php echo $i; ?>)" onmouseout="Total_Soft_Poll_Video_Out(<?php echo $Total_Soft_Poll; ?>, <?php echo $i; ?>)" <?php } ?>>
                <div class="Total_Soft_Poll_1_Ans_Check_Div_BO_<?php echo $Total_Soft_Poll; ?>"
                 style=" <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_CA=='Background'){ ?>background: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;
																	} ?>">
                     ...
                     <div class="Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll; ?>">
																						<?php if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType=='Video Poll'){ ?>
                        <div class="Total_Soft_Poll_1_Ans_Div_Play_Overlay_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_1_Ans_Div_Play_Overlay_<?php echo $Total_Soft_Poll; ?>_<?php echo $i; ?>"
                         onclick='Total_Soft_Poll_Video_Play(<?php echo $Total_Soft_Poll; ?>, "<?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Vd; ?>")'>
                                                    <span class="Total_Soft_Poll_1_Ans_Div_Video_Icon_Sp_<?php echo $Total_Soft_Poll; ?>"><i
                   ...
                   <input type="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_CH_CM=='true'){
                    ...
                    id="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                    name="<?php echo $Total_Soft_Poll_1_Check_Name; ?>"
                    value="<?php echo $Total_Soft_Poll_Ans[$i]->id; ?>">
                   <label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?> totalsoft totalsoft-question-circle-o"
                    for="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                    style="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_CA=='Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>"><?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_Pos=='Position 1'||$Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_Pos=='Position 3'){
																					echo html_entity_decode($Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans);
																				}
                   ...
                   <script type="text/javascript">
                     jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?> img').css('display', 'none')
                   </script>
                   <input type="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_CH_CM=='true'){
																				echo 'checkbox';
																			}
                   ...
                   <label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?> totalsoft totalsoft-question-circle-o"
                    for="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                    style="  <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_CA == 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?> float: left !important; width: 22px; top: 50% !important; padding-left: 3px;"><?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_Pos=='Position 1'||$Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_Pos=='Position 3'){
																					echo html_entity_decode($Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans);
																				} ?></label>
                   <div class="Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll; ?>"
                   ...
                   <label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?> totalsoft totalsoft-question-circle-o"
                    for="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                    style="  <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_CA == 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?> float: left !important; width: 22px; top: 50%; padding-left: 3px;"><?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_Pos=='Position 1'||$Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_Pos=='Position 3'){
																					echo html_entity_decode($Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans);
																				} ?></label>
																	<?php } ?>
             ...
             <div class="Total_Soft_Poll_1_LAA_Div_<?php echo $Total_Soft_Poll; ?>"></div>
              ...
              <script type="text/javascript">
               ...
               function f() {
                 y=(x + 10) / jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div_BO_<?php echo $Total_Soft_Poll;?>').width()

																<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH=='1'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', (1 - y) * 100 + '%')
                 /*16x9*/
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH=='2'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', (1 - y) * 56.25 + '%')
                 /*9x16*/
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH=='3'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', (1 - y) * 177.78 + '%')
                 /*3x4*/
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH=='4'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', (1 - y) * 133.3 + '%')
                 /*4x3*/
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH=='5'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', (1 - y) * 75 + '%')
                 /*3x2*/
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH=='6'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', (1 - y) * 66.7 + '%')
                 /*2x3*/
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH=='7'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', (1 - y) * 150 + '%')
                 /*8x5*/
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH=='8'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', (1 - y) * 62.5 + '%')
                 /*5x8*/
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH=='9'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', (1 - y) * 160 + '%')
																<?php }else{ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', '<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH;?>px;')
																<?php }?>

                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('width', jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div_BO_<?php echo $Total_Soft_Poll;?>').width() - x - 10 + 'px');

																<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_CH_S=='big'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label').css('top', parseInt(jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom'), 10) / 2 - (x / 4) + 'px')
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_CH_S=='medium 2'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label').css('top', parseInt(jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom'), 10) / 2 - (x / 3) + 'px')
																<?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_CH_S=='medium 1'){ ?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label').css('top', parseInt(jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom'), 10) / 2 - (x / 3) + 'px')
                 ...
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label').css('top', parseInt(jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom'), 10) / 2 - (x / 2) + 'px')
																<?php }?>
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div_BO_<?php echo $Total_Soft_Poll;?>').css('height', jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom'))
                 jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?>').css('display', '')
               }
           ...
           <div class="Total_Soft_Poll_1_But_MDiv_<?php echo $Total_Soft_Poll; ?>">
              ...
              <button class="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
               id="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
               name="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>" type="button"
               value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_RB_Text); ?>"
               onclick="Total_Soft_Poll_2_Result(<?php echo $Total_Soft_Poll; ?>)">
                <i class="totalsoft Total_Soft_Poll_1_Result_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_RB_Text); ?></span> </i>
              </button>
												<?php } ?>
												<?php
												$cookie=(isset($_COOKIE["TotalSoft_Poll_Cookie_" . $Total_Soft_Poll])) ? $_COOKIE["TotalSoft_Poll_Cookie_" . $Total_Soft_Poll]:'';
												if($cookie==''){ ?>
              <button class="Total_Soft_Poll_2_But_Vote Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>"
               id="Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>"
               name="Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>" type="button"
               value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_VB_Text); ?>"
               onclick="Total_Soft_Poll_2_But_Vote(<?php echo $Total_Soft_Poll; ?>, event)">
                <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_VB_Text); ?></span></i>
              </button>
												<?php } ?>
												<?php if($cookie&&$Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10!="true"){ ?>
              <button class="Total_Soft_Poll_2_But_Vote Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>"
           ...
           <div class="Total_Soft_Poll_1_BBut_MDiv_<?php echo $Total_Soft_Poll; ?>">
             ...
             <button class="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
              id="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
              name="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>" type="button"
              value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_P_BB_Text); ?>"
              onclick="Total_Soft_Poll_2_Back(<?php echo $Total_Soft_Poll; ?>)">
               <i class="totalsoft Total_Soft_Poll_1_Back_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_2_P_BB_Text); ?></span> </i>
             </button>
           </div>
         </div>
         <input type="text" style="display: none;"
          id="TotalSoft_Poll_2_P_A_VEff_<?php echo $Total_Soft_Poll ?>"
          value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_P_A_VEff; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_ID"
          value="<?php echo $Total_Soft_Poll; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Vote"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_02_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_02; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_03_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_03; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_04_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo html_entity_decode($Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_04); ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_05_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo html_entity_decode($Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_05); ?>">
			...
			<?php if($Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType=='Video Poll'){ ?>
				  <div class="Total_Soft_Poll_1_Ans_Fix_<?php echo $Total_Soft_Poll; ?>" onclick="Total_Soft_Poll_Video_Close(<?php echo $Total_Soft_Poll; ?>)"></div>  
				   <div class="Total_Soft_Poll_1_Ans_Fix_1_<?php echo $Total_Soft_Poll; ?>">  <div class="Total_Soft_Poll_1_Ans_Fix_2_<?php echo $Total_Soft_Poll; ?>"><iframe src="" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
				</div>
			<?php } ?>
     ...
     <style type="text/css">
         ...
         <?php } else { ?> margin: 0 auto;
         <?php }?> border: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BW;?>px solid<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BC;?>;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Show == 'false' || $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'none'){ ?> -webkit-box-shadow: none;
             -moz-box-shadow: none;
             box-shadow: none;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'true'){ ?> -webkit-box-shadow: 0px 0px 13px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'false'){ ?> -webkit-box-shadow: 0 25px 13px -18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'sh03'){ ?> box-shadow: 0 10px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'sh04'){ ?> box-shadow: 0 1px 4px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>, 0 0 40px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?> inset;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'sh05'){ ?> box-shadow: 0 0 10px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'sh06'){ ?> box-shadow: 4px -4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'sh07'){ ?> box-shadow: 5px 5px 3px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'sh08'){ ?> box-shadow: 2px 2px white, 4px 4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'sh09'){ ?> box-shadow: 8px 8px 18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'sh10'){ ?> box-shadow: 0 8px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh_Type == 'sh11'){ ?> box-shadow: 0 0 18px 7px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxShC;?>;
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div {
             ...
             width: 100%;
             padding: 0 !important;
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_CA != 'Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_BgC;?>;
         <?php }?> border: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_BW;?>px solid<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_BC;?>;
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label {
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_CA != 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_C;?> !important;
         <?php }?> font-size: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_FS;?>px !important;
             cursor: pointer;
             margin-bottom: 0px !important;
         ...
         <?php } else { ?> font-family: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_BoxSh;?>;
         <?php }?>
         }

         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label:before {
         <?php if( $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_CH_Sh == 'true'){ ?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_CH_CBC;?>;
             content: "\<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_CH_TBC;?>";<?php } else { ?> content: " " !important;<?php }?> margin: 0 .25em 0 0 !important;
             padding: 0 !important;
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input:checked + label:before {
         <?php if( $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_CH_Sh == 'true'){ ?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_CH_CAC;?> !important;
             content: "\<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_CH_TAC;?>";<?php } else { ?> content: " " !important;<?php }?>
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_RB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_RB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_RB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_RB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_RB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_RB_C;?> !important;
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_TV_Pos=='center'){ ?> width: 98% !important;
             margin: 5px 1% !important;
             text-align: center;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_TV_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: default;
         ...
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_VT_IT;?>";
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_BB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_BB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_BB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_BB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_BB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_BB_C;?> !important;
         }
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_V_CA != 'Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_V_BgC;?> !important;
         <?php }?> border-radius: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_BR-2;?>px;
         }
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_V_CA != 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_V_C;?> !important;
       ...
       <div class="Total_Soft_Poll_Main_Div">
         <div class="Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll; ?>">
           ...
           <div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll; ?>">
												<?php for($i=0;$i<$Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C;$i ++){ ?>
              <div class="Total_Soft_Poll_1_Ans_Check_Div"
               style="/*height:40px;*/<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_CA=='Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl; } ?>">
                <input type="radio" class="Total_Soft_Poll_1_Ans_CheckBox"
                 id="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                 name="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>"
                 value="<?php echo $Total_Soft_Poll_Ans[$i]->id; ?>">
															<?php
															$cookie=(isset($_COOKIE["TotalSoft_Poll_Cookie_" . $Total_Soft_Poll])) ? $_COOKIE["TotalSoft_Poll_Cookie_" . $Total_Soft_Poll]:'';
															if($cookie==''){ ?>
                 <label class="Total_Soft_Poll_1_Ans_Lab Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?> totalsoft totalsoft-question-circle-o"
                  for="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                  style="width:100%;height:100%;box-sizing:border-box;<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_3_A_CA=='Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>"
                  onclick="Total_Soft_Poll_1_Ans_Lab('<?php echo $Total_Soft_Poll_Ans[$i]->id; ?>',<?php echo $Total_Soft_Poll; ?>, event)"><?php echo html_entity_decode($Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans); ?></label>
															<?php } ?>
															<?php if($cookie&&$Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10!="true"){ ?>
                 <label class="Total_Soft_Poll_1_Ans_Lab Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?> totalsoft totalsoft-question-circle-o"
                  for="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                ...
                <span class="Total_Soft_Poll_3_Span_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                 style="width:100%;height:100%;box-sizing:border-box;">
												<span class="Total_Soft_Poll_3_Span3_<?php echo $Total_Soft_Poll; ?>">
													<span class="Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                           style="<?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_V_CA=='Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl; } ?>; <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_V_Eff=='0'){ ?> width: <?php echo round($Total_Soft_Poll_Res[$i]->Poll_A_Votes * 100 / $Total_Soft_Poll_Res_Count,2) . '%'; } ?>">
													</span>
													<label class="Total_Soft_Poll_3_Span2_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span2_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                           style="<?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_V_CA=='Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>">
           ...
           <div class="Total_Soft_Poll_1_But_MDiv_<?php echo $Total_Soft_Poll; ?>">
              ...
              <button class="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
               id="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
               name="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>" type="button"
               value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_RB_Text); ?>"
               onclick="Total_Soft_Poll_3_Result(<?php echo $Total_Soft_Poll; ?>)">
                <i class="totalsoft Total_Soft_Poll_1_Result_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_RB_Text); ?></span> </i>
              </button>
												<?php } ?>
												<?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_TV_Show=='true'){ ?>
              <i class="totalsoft Total_Soft_Poll_1_Total_View_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_TV_Text) . ' : ' . $Total_Soft_Poll_Res_Count1; ?></span> </i>
												<?php } ?>
           </div>
           <div class="Total_Soft_Poll_1_BBut_MDiv_<?php echo $Total_Soft_Poll; ?>">
             <div class="Total_Soft_Poll_1_Div_Cook_<?php echo $Total_Soft_Poll; ?>"></div>
             <button class="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
              id="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
              name="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>" type="button"
              value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_BB_Text); ?>"
              onclick="Total_Soft_Poll_3_Back(<?php echo $Total_Soft_Poll; ?>)">
               <i class="totalsoft Total_Soft_Poll_1_Back_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_BB_Text); ?></span> </i>
             </button>
           </div>
         </div>
         <input type="text" style="display: none;" id="TotalSoft_Poll_3_ID"
          value="<?php echo $Total_Soft_Poll; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_3_Vote"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_3_V_Eff_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_V_Eff; ?>"> <input type="text" style="display: none;" id="TotalSoftPoll_Ans_C_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_02_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_02; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_03_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_03; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_04_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo html_entity_decode($Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_04); ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_05_<?php echo $Total_Soft_Poll; ?>"
     ...
     <style type="text/css">
         ...
         <?php } else { ?> margin: 0 auto;
         <?php }?> border: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BW;?>px solid<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BC;?>;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Show == 'false' || $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'none'){ ?> -webkit-box-shadow: none;
             -moz-box-shadow: none;
             box-shadow: none;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'true'){ ?> -webkit-box-shadow: 0px 0px 13px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'false'){ ?> -webkit-box-shadow: 0 25px 13px -18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'sh03'){ ?> box-shadow: 0 10px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'sh04'){ ?> box-shadow: 0 1px 4px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>, 0 0 40px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?> inset;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'sh05'){ ?> box-shadow: 0 0 10px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'sh06'){ ?> box-shadow: 4px -4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'sh07'){ ?> box-shadow: 5px 5px 3px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'sh08'){ ?> box-shadow: 2px 2px white, 4px 4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'sh09'){ ?> box-shadow: 8px 8px 18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'sh10'){ ?> box-shadow: 0 8px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxSh_Type == 'sh11'){ ?> box-shadow: 0 0 18px 7px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_BoxShC;?>;
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div {
             ...
             width: 100%;
             padding: 0 !important;
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_CA != 'Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_BgC;?>;
         <?php }?> border: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_BW;?>px solid<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_BC;?>;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_CA != 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_C;?> !important;
         <?php }?> font-size: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_FS;?>px !important;
             cursor: pointer;
             margin-bottom: 0px !important;
             position: relative;
             top: 50%;
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div1 {
             position: relative;
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '1'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '2'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*16/9;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '3'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*9/16;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '4'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*3/4;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '5'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*4/3;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '6'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*3/2;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '7'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*2/3;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '8'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*8/5;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '9'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*5/8;?>px;
         <?php }?> height: 100%;
             float: left;
         }
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div2 {
             position: relative;
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '1'){ ?> width: calc(100% - <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H;?>px);
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '2'){ ?> width: calc(100% - <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*16/9;?>px);
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '3'){ ?> width: calc(100% - <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*9/16;?>px);
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '4'){ ?> width: calc(100% - <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*3/4;?>px);
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '5'){ ?> width: calc(100% - <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*4/3;?>px);
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '6'){ ?> width: calc(100% - <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*3/2;?>px);
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '7'){ ?> width: calc(100% - <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*2/3;?>px);
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '8'){ ?> width: calc(100% - <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*8/5;?>px);
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_Ra == '9'){ ?> width: calc(100% - <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_I_H*5/8;?>px);
         <?php }?> height: 100%;
             float: left;
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_RB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_RB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_RB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_RB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_RB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_RB_C;?> !important;
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_TV_Pos=='center'){ ?> width: 98% !important;
             margin: 5px 1% !important;
             text-align: center;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_TV_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: default;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_TV_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_VT_IA=='after'){ ?> float: right;
             margin-left: 5px;
         <?php }else{ ?> margin-right: 3px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_VT_IT;?>";
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_BB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_BB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_BB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_BB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_BB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_BB_C;?> !important;
         }
         ...
         @media only screen and ( max-width: 500px ) {
             ...
             .Total_Soft_Poll_1_Ans_Fix_2_<?php echo $Total_Soft_Poll;?>, .Total_Soft_Poll_1_Ans_Fix_3_<?php echo $Total_Soft_Poll;?> img {
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll;?> {
             ...
             height: 100%;
             min-width: 10px !important;
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_V_CA != 'Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_V_BgC;?> !important;
         <?php }?> border-radius: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_BR-2;?>px;
         }
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_3_Span2_<?php echo $Total_Soft_Poll;?> {
             ...
             width: 100%;
             padding: 0px 15px;
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_V_CA != 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_V_C;?> !important;
     ...
     <form method="POST" onsubmit="">
       <div class="Total_Soft_Poll_Main_Div">
         <div class="Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll; ?>">
           ...
           <div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll; ?>">
												<?php for($i=0;$i<$Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C;$i ++){
													...
													?>
              <div class="Total_Soft_Poll_1_Ans_Check_Div"
               style="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_CA=='Background'){ ?>background-color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;
															} ?>">
                  ...
                  <div class="Total_Soft_Poll_1_Ans_Check_Div1_Ov Total_Soft_Poll_1_Ans_Check_Div1_Ov_<?php echo $Total_Soft_Poll; ?>">
													<span>
														<i class="totalsoft Total_Soft_Poll_1_IM_Or_VI_Icon"></i>
															...
															if($cookie==''){ ?>
                 <div class="Total_Soft_Poll_1_Ans_Check_Div2 Total_Soft_Poll_1_Ans_Check_Div2_<?php echo $Total_Soft_Poll; ?>"
                  onclick="Total_Soft_Poll_1_Ans_Check_Div2('<?php echo $Total_Soft_Poll_Ans[$i]->id; ?>',<?php echo $Total_Soft_Poll; ?>,event)">
                   <label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?>"
                    style="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_A_CA=='Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>"><?php echo html_entity_decode($Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans); ?></label>
                 </div>
															<?php } ?>
															<?php if($cookie&&$Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10!="true"){ ?>
                 <div class="Total_Soft_Poll_1_Ans_Check_Div2 Total_Soft_Poll_1_Ans_Check_Div2_<?php echo $Total_Soft_Poll; ?>"
                ...
                <span class="Total_Soft_Poll_3_Span_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>">
												<span class="Total_Soft_Poll_3_Span3_<?php echo $Total_Soft_Poll; ?>">
													<span class="Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                           style="<?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_V_CA=='Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl; } ?>; <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_V_Eff=='0'){ ?> width: <?php echo round($Total_Soft_Poll_Res[$i]->Poll_A_Votes * 100 / $Total_Soft_Poll_Res_Count,2) . '%'; } ?>">
													</span>
													<label class="Total_Soft_Poll_3_Span2_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span2_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                           style="<?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_V_CA=='Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>">
           ...
           <div class="Total_Soft_Poll_1_But_MDiv_<?php echo $Total_Soft_Poll; ?>">
              ...
              <button class="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
               id="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
               name="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>" type="button"
               value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_RB_Text); ?>"
               onclick="Total_Soft_Poll_4_Result(<?php echo $Total_Soft_Poll; ?>)">
                <i class="totalsoft Total_Soft_Poll_1_Result_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_RB_Text); ?></span> </i>
              </button>
												<?php } ?>
												<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_TV_Show=='true'){ ?>
              <i class="totalsoft Total_Soft_Poll_1_Total_View_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_TV_Text) . ' : ' . $Total_Soft_Poll_Res_Count1; ?></span> </i>
												<?php } ?>
           </div>
           <div class="Total_Soft_Poll_1_BBut_MDiv_<?php echo $Total_Soft_Poll; ?>">
             <div class="Total_Soft_Poll_1_Div_Cook_<?php echo $Total_Soft_Poll; ?>"></div>
             <button class="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
              id="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
              name="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>" type="button"
              value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_BB_Text); ?>"
              onclick="Total_Soft_Poll_4_Back(<?php echo $Total_Soft_Poll; ?>)">
               <i class="totalsoft Total_Soft_Poll_1_Back_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_BB_Text); ?></span> </i>
             </button>
           </div>
         </div>
         <input type="text" style="display: none;" id="TotalSoft_Poll_3_IV_ID"
          value="<?php echo $Total_Soft_Poll; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_3_IV_Vote"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>">


         <input type="text" style="display: none;" id="TotalSoft_Poll_3_V_Eff_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_V_Eff; ?>"> <input type="text" style="display: none;" id="TotalSoftPoll_Ans_C_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_02_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_02; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_03_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_03; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_04_<?php echo $Total_Soft_Poll; ?>"
         ...
         <div class="Total_Soft_Poll_1_Ans_Fix_<?php echo $Total_Soft_Poll; ?>"
          onclick="Total_Soft_Poll_Video_Close(<?php echo $Total_Soft_Poll; ?>)"></div>
         <div class="Total_Soft_Poll_1_Ans_Fix_1_<?php echo $Total_Soft_Poll; ?>">
           <div class="Total_Soft_Poll_1_Ans_Fix_2_<?php echo $Total_Soft_Poll; ?>">
             <i class="totalsoft Total_Soft_Poll_1_Popup_Close_IconV_<?php echo $Total_Soft_Poll; ?>"
              onclick="Total_Soft_Poll_Video_Close(<?php echo $Total_Soft_Poll; ?>)"></i>
             <iframe src="" frameborder="0" webkitAllowFullScreen mozallowfullscreen
              allowFullScreen></iframe>
				...
				<?php }else{ ?>
         <div class="Total_Soft_Poll_1_Ans_Fix_<?php echo $Total_Soft_Poll; ?>"
          onclick="Total_Soft_Poll_Image_Close(<?php echo $Total_Soft_Poll; ?>)"></div>
         <div class="Total_Soft_Poll_1_Ans_Fix_3_<?php echo $Total_Soft_Poll; ?>"
          onclick="Total_Soft_Poll_Image_Close(<?php echo $Total_Soft_Poll; ?>)">
           <img src=""/> <i class="totalsoft Total_Soft_Poll_1_Popup_Close_Icon_<?php echo $Total_Soft_Poll; ?>"
            onclick="Total_Soft_Poll_Image_Close(<?php echo $Total_Soft_Poll; ?>)"></i>
         </div>
				<?php } ?>
			<?php } ?>
			<?php
     ...
     <style type="text/css">
         ...
         <?php } else { ?> margin: 0 auto;
         <?php }?> border: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BW;?>px solid<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BC;?>;
         ...
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Show == 'false' || $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'none'){ ?> -webkit-box-shadow: none;
             -moz-box-shadow: none;
             box-shadow: none;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'true'){ ?> -webkit-box-shadow: 0px 0px 13px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'false'){ ?> -webkit-box-shadow: 0 25px 13px -18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'sh03'){ ?> box-shadow: 0 10px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'sh04'){ ?> box-shadow: 0 1px 4px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>, 0 0 40px <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?> inset;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'sh05'){ ?> box-shadow: 0 0 10px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'sh06'){ ?> box-shadow: 4px -4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'sh07'){ ?> box-shadow: 5px 5px 3px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'sh08'){ ?> box-shadow: 2px 2px white, 4px 4px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'sh09'){ ?> box-shadow: 8px 8px 18px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'sh10'){ ?> box-shadow: 0 8px 6px -6px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh_Type == 'sh11'){ ?> box-shadow: 0 0 18px 7px<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxShC;?>;
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div {
             ...
             width: 100%;
             padding: 0 !important;
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_CA != 'Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_BgC;?>;
         <?php }?> border: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_BW;?>px solid<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_BC;?>;
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label {
         <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_CA != 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_C;?> !important;
         <?php }?> font-size: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_FS;?>px !important;
             cursor: pointer;
             margin-bottom: 0px !important;
         ...
         <?php } else { ?> font-family: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_BoxSh;?>;
         <?php }?>
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_RB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_RB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_RB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_RB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_RB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_RB_C;?> !important;
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_TV_Pos=='center'){ ?> width: 98% !important;
             margin: 5px 1% !important;
             text-align: center;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_TV_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: default;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_TV_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_VT_IA=='after'){ ?> float: right;
             margin-left: 5px;
         <?php }else{ ?> margin-right: 3px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_VT_IT;?>";
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_BB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_BB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_BB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_BB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_BB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_BB_C;?> !important;
         }
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll;?> {
             ...
             height: 100%;
             min-width: 10px !important;
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_V_CA != 'Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_V_BgC;?> !important;
         <?php }?> border-radius: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_BR-2;?>px;
         }
         ...
         .Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_3_Span2_<?php echo $Total_Soft_Poll;?> {
             ...
             height: 100%;
             padding: 10px 10px 5px 10px;
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_V_CA != 'Color'){ ?> color: <?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_V_C;?> !important;
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_VB_Pos=='full'){ ?> width: 98% !important;
             margin: 5px 1% !important;
         <?php }?> color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_VB_C;?> !important;
             padding: 3px 10px !important;
             text-transform: none !important;
             line-height: 1 !important;
             cursor: pointer;
         ...
         <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_VB_Text!=''){ ?> <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_VB_IA=='after'){ ?> float: right;
             margin-left: 10px;
         <?php }else{ ?> margin-right: 10px;
         <?php }?> <?php }?> content: "\<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_VB_IT;?>";
             color: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_VB_C;?> !important;
         }
         ...
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_Ra == '2'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H*16/9;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_Ra == '3'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H*9/16;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_Ra == '4'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H*3/4;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_Ra == '5'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H*4/3;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_Ra == '6'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H*3/2;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_Ra == '7'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H*2/3;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_Ra == '8'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H*8/5;?>px;
         <?php }else if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_Ra == '9'){ ?> width: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H*5/8;?>px;
         <?php }?> height: <?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_I_H;?>px !important;
             padding: 0 !important;
             float: none !important;
         }
       ...
       <div class="Total_Soft_Poll_Main_Div">
         <div class="Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll; ?>">
           ...
           <div class="Total_Soft_Poll_1_Quest_Div_<?php echo $Total_Soft_Poll; ?>">
              ...
              <label> <img src="<?php echo $Total_Soft_Poll_Q_M[0]->TotalSoftPoll_Q_Im; ?>"> </label>
              ...
              <div class="Total_Soft_Poll_1_Q_Iframe_1_<?php echo $Total_Soft_Poll; ?>">
                <div class="Total_Soft_Poll_1_Q_Iframe_2_<?php echo $Total_Soft_Poll; ?>">
                  <iframe src="<?php echo $Total_Soft_Poll_Q_M[0]->TotalSoftPoll_Q_Vd; ?>"
           ...
           <div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll; ?>">
												<?php for($i=0;$i<$Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C;$i ++){ ?>
              <div class="Total_Soft_Poll_1_Ans_Check_Div"
               style="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_CA=='Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl; } ?>">
                <input type="radio" class="Total_Soft_Poll_1_Ans_CheckBox"
                 id="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                 name="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>"
                 value="<?php echo $Total_Soft_Poll_Ans[$i]->id; ?>"> <label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?> totalsoft totalsoft-question-circle-o"
                 for="Total_Soft_Poll_1_Ans_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                 style="<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_CA=='Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>"
																<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_VB_Show!='true'){ ?>onclick="Total_Soft_Poll_3_Vote(<?php echo $Total_Soft_Poll; ?>, <?php echo $Total_Soft_Poll_Ans[$i]->id; ?>,'<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>')" <?php } ?>><?php echo html_entity_decode($Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans); ?></label> <span class="Total_Soft_Poll_3_Span_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>">
												<span class="Total_Soft_Poll_3_Span3_<?php echo $Total_Soft_Poll; ?>">
													<span class="Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                           style="<?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_V_CA=='Background'){ ?> background-color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl; } ?>; <?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_V_Eff=='0'){ ?> width: <?php echo round($Total_Soft_Poll_Res[$i]->Poll_A_Votes * 100 / $Total_Soft_Poll_Res_Count,2) . '%'; } ?>">
													</span>
													<label class="Total_Soft_Poll_3_Span2_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span2_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                           style="<?php if($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_V_CA=='Color'){ ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>">
           ...
           <div class="Total_Soft_Poll_1_But_MDiv_<?php echo $Total_Soft_Poll; ?>">
                ...
                <label style="display: block; width: 100%; line-height: 1 !important; margin-bottom: 0 !important; padding: 0 !important; float: left;"> <i class="totalsoft Total_Soft_Poll_1_Total_View_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_TV_Text) . ' : ' . $Total_Soft_Poll_Res_Count1; ?></span> </i> </label>
													<?php }else{ ?>
                <i class="totalsoft Total_Soft_Poll_1_Total_View_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_TV_Text) . ' : ' . $Total_Soft_Poll_Res_Count1; ?></span> </i>
													<?php } ?>
												<?php } ?>
              ...
              <button class="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
               id="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>"
               name="Total_Soft_Poll_1_But_Result_<?php echo $Total_Soft_Poll; ?>" type="button"
               value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_RB_Text); ?>"
               onclick="Total_Soft_Poll_3_Result(<?php echo $Total_Soft_Poll; ?>)">
                <i class="totalsoft Total_Soft_Poll_1_Result_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_RB_Text); ?></span> </i>
              </button>
												<?php } ?>
												<?php if($Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_VB_Show=='true'){ ?>
													<?php $cookie=(isset($_COOKIE["TotalSoft_Poll_Cookie_" . $Total_Soft_Poll])) ? $_COOKIE["TotalSoft_Poll_Cookie_" . $Total_Soft_Poll]:'';
													if($cookie==''){ ?>
               <button class="Total_Soft_Poll_5_But_Vote Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>"
                id="Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>"
                name="Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>" type="button"
                value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_VB_Text); ?>"
                onclick="Total_Soft_Poll_5_But_Vote(<?php echo $Total_Soft_Poll; ?>, event)">
                 <i class="totalsoft Total_Soft_Poll_1_Vote_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_VB_Text); ?></span> </i>
               </button>
													<?php } ?>
													<?php if($cookie&&$Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10!="true"){ ?>
                <button class="Total_Soft_Poll_5_But_Vote Total_Soft_Poll_1_But_Vote_<?php echo $Total_Soft_Poll; ?>"
           ...
           <div class="Total_Soft_Poll_1_BBut_MDiv_<?php echo $Total_Soft_Poll; ?>">
             ...
             <button class="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
              id="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>"
              name="Total_Soft_Poll_1_But_Back_<?php echo $Total_Soft_Poll; ?>" type="button"
              value="<?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_BB_Text); ?>"
              onclick="Total_Soft_Poll_3_Back(<?php echo $Total_Soft_Poll; ?>)">
               <i class="totalsoft Total_Soft_Poll_1_Back_But_Icon"> <span><?php echo html_entity_decode($Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_BB_Text); ?></span> </i>
             </button>
           </div>
         </div>

         <input type="text" style="display: none;" id="TotalSoft_Poll_5_IV_ID"
          value="<?php echo $Total_Soft_Poll; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_5_IV_Vote"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_3_V_Eff_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_V_Eff; ?>"> <input type="text" style="display: none;" id="TotalSoftPoll_Ans_C_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; ?>"> <input type="text" style="display: none;"
          id="TotalSoft_Poll_5_TV_Show_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_TV_Show; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_02_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_02; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_03_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_03; ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_04_<?php echo $Total_Soft_Poll; ?>"
          value="<?php echo html_entity_decode($Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_04); ?>"> <input type="text" style="display: none;" id="TotalSoft_Poll_Set_05_<?php echo $Total_Soft_Poll; ?>"
